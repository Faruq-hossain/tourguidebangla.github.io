      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <h1>All posts of month: <?php echo month_number_to_detail($_REQUEST['month']); ?> and year: <?php echo $_REQUEST['year']; ?></h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="blog mt50">
      <div class="col-md-9">
        ...
        $q = $pdo->prepare("
              ...
              WHERE post_month=? AND post_year=?
              ORDER BY t1.post_id DESC
            ");
        $q->execute([$_REQUEST['month'], $_REQUEST['year']]);
        $res = $q->fetchAll();
        $tot = $q->rowCount();
