        ...
        <div class="row">
          <div class="col-sm-12">
            <ol class="breadcrumb">
              ...
              <li class="active">Tour Gallery</li>
            </ol>
            <h1>Tour Gallery</h1>
          </div>
        </div>
...
<section id="gallery" class="mt50">
  <div class="container">
    <div class="row gallery">
      <?php
      $q = $pdo->prepare("SELECT * FROM photo_tour ORDER BY photo_id ASC");
      $q->execute();
      $res = $q->fetchAll();
      foreach ($res as $row) {
      ?>
        <div class="col-sm-3 cat<?php echo $row['photo_category_id']; ?> fadeIn appear" data-start="200"> <a href="../touruploads/<?php echo $row['photo_name']; ?>" data-rel="prettyPhoto[gallery1]"><img src="../touruploads/<?php echo $row['photo_name']; ?>" alt="image" class="img-responsive zoom-img" /><i class="fa fa-search"></i></a> </div>
      <?php
      }
      ?>
    </div>
