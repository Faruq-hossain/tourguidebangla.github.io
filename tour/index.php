  ...
  <div class="bannercontainer">
    <div class="banner">
      <ul>
        ...
        <?php
        $q = $pdo->prepare("SELECT * FROM slider_tour ORDER BY slider_id ASC");
        $q->execute();
        $res = $q->fetchAll();
        foreach ($res as $row) {
        ?>
      ...
      <div class="col-md-12">
        <form class="form-inline reservation-horizontal clearfix" role="form" method="post" action="">
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label for="room">How Many Adults?</label>
...
<section class="rooms mt50">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h2 class="lined-heading"><span>Guests Favorite Tours</span></h2>
      </div>
          ...
          <div class="room-thumb"> <img src="../touruploads/<?php echo $row['room_featured_photo']; ?>" alt="room 1" class="img-responsive" />
            <div class="mask">
              ...
              <div class="content">
                ...
                <a href="tour.php?id=<?php echo $row['room_id']; ?>" class="btn btn-primary btn-block">Read More</a>
              </div>
            </div>
          </div>
        </div>
...
<section class="usp mt100">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h2 class="lined-heading"><span>Tour Feature</span></h2>
      </div>
        ...
        <ul class="nav nav-tabs">
          ...
          ?>
            <li <?php
                ...
                ?>>
              <a href="#abc<?php echo $i; ?>" data-toggle="tab">
