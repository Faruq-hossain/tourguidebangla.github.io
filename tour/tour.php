...
if (isset($_POST['form1'])) {
  ...
  if ($valid == 1) {
    ...
    if (isset($_SESSION['cart_room_id'])) {
      ...
      $arr_room_day = array();
      $i = 0;
      foreach ($_SESSION['cart_room_day'] as $val) {
        $i++;
        $arr_room_day[$i] = $val;
      }
      ...
      if (in_array($_REQUEST['id'], $arr_room_id)) {
        $valid = 0;
        $error_message .= 'This tour is already added to the cart';
      } else {
        $new_key = $i + 1;
        ...
        $_SESSION['cart_room_day'][$new_key] = $_POST['room_day'];
      ...
      $_SESSION['cart_room_day'][1] = $_POST['room_day'];
    ...
    <section class="room-slider standard-slider mt50">
      <div class="col-sm-12 col-md-8">
        <div id="owl-standard" class="owl-carousel">
          ...
          <div class="item">
            <a href="../touruploads/<?php echo $room_featured_photo; ?>" data-rel="prettyPhoto[gallery1]">
              <img src="../touruploads/<?php echo $room_featured_photo; ?>" alt="Bed" class="img-responsive">
            </a>
          </div>


          <?php
          $q = $pdo->prepare("SELECT * FROM tour_photo WHERE room_id=? ORDER BY room_photo_id ASC");
          $q->execute([$_REQUEST['id']]);
          $res = $q->fetchAll();
          foreach ($res as $row) {
          ?>
            <div class="item">
              <a href="../touruploads/<?php echo $row['room_photo']; ?>" data-rel="prettyPhoto[gallery1]">
                <img src="../touruploads/<?php echo $row['room_photo']; ?>" alt="Bathroom" class="img-responsive">
              </a>
            </div>
          <?php
          }
    ...
    <section id="reservation-form" class="mt50 clearfix">
      <div class="col-sm-12 col-md-4">
        ...
        <form class="reservation-vertical clearfix" role="form" method="post" action="">
          ...
          <input type="hidden" name="room_day" value="<?php echo $room_day; ?>">
          ...
          <div class="price">
            ...
            $ <?php echo $room_price; ?><br><span> <?php echo $room_day; ?></span>
          </div>
          ...
          <div class="form-group">
            <label for="checkout">How many Adults</label>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-7 mt50">
            <h2 class="lined-heading"><span>Tours Details</span></h2>
...
<section class="rooms mt50">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h2 class="lined-heading"><span>Related Tours</span></h2>
      </div>
          ...
          <div class="room-thumb"> <img src="../touruploads/<?php echo $row['room_featured_photo']; ?>" alt="room 1" class="img-responsive" />
            <div class="mask">
              ...
              <div class="content">
                ...
                <a href="tour.php?id=<?php echo $row['room_id']; ?>" class="btn btn-primary btn-block">View Details</a>
                <a href="tour.php?id=<?php echo $row['room_id']; ?>" class="btn btn-primary btn-block">Book Now</a>
