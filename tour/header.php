            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="../home.php" class="navbar-brand">
                        <!-- Logo -->
                        <div id="logo"> <img id="default-logo" src="images/logo2.png" alt="Tourguidebangla" style="height:44px;"> <img id="retina-logo" src="images/logo2.png" alt="Starhotel" style="height:44px;"> </div>
                    </a>
                </div>
