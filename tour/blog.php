  ...
  <div class="row">
    ...
    <section class="blog mt50">
      <div class="col-md-9">
        ...
        <?php
        $per_page = 5;
        $q = $pdo->prepare("SELECT * FROM post_tour");
        $q->execute();
        $total = $q->rowCount();
        ...
        ?>
          <article> <a href="blog-detail.php?id=<?php echo $row['post_id']; ?>" class="mask"><img src="../touruploads/<?php echo $row['post_photo']; ?>" alt="image" class="img-responsive zoom-img"></a>
            <div class="row">
            ...
            <ul class="pagination clearfix">
              ...
              if (!isset($_REQUEST['p'])) {
                ...
                if ($_REQUEST['p'] == 1) {
                  ...
                  echo '<li><a href="http://localhost/tourhotel/tour/blog.php?p=' . ($_REQUEST['p'] - 1) . '">«</a></li>';
                }
              }
              ?>
              ...
              for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li class="' . $active . '"><a href="http://localhost/tourhotel/tour/blog.php?p=' . $i . '">' . $i . '</a></li>';
              }
              ?>

              <?php
              if (!isset($_REQUEST['p'])) {
                echo '<li><a href="http://localhost/tourhotel/tour/blog.php?p=2">»</a></li>';
              } else {
