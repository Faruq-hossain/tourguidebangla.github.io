        ...
        <div class="row">
          <div class="col-sm-12">
            <ol class="breadcrumb">
              ...
              <li class="active">Tours list view</li>
            </ol>
  ...
  <div class="row">
    <div class="col-sm-12">
      <ul class="nav nav-pills" id="filters">
        ...
        <?php
        $q = $pdo->prepare("SELECT * FROM tour_type ORDER BY room_type_id ASC");
        $q->execute();
        $res = $q->fetchAll();
        foreach ($res as $row) {
        ?>
...
<section class="rooms mt100">
  <div class="container">
    <div class="row room-list fadeIn appear">
      ...
      <?php
      $q = $pdo->prepare("SELECT * FROM tour ORDER BY room_id ASC");
      $q->execute();
      $res = $q->fetchAll();
      foreach ($res as $row) {
      ?>
        ...
        <div class="col-sm-4 ty<?php echo $row['room_type_id']; ?>">
          <div class="room-thumb">
            <img src="../touruploads/<?php echo $row['room_featured_photo']; ?>" alt="room 1" class="img-responsive">
            <div class="mask">
              <div class="main">
