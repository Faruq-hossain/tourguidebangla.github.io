...
$stripe_secret_key = 'sk_test_51M29rPGTuPxoc4fRlMabSGMhsF1s3fEFfEO1CNK1oYygMIbeNcBGZuzWdFhEamZ2Iri0r8fxjnMzdd4jFjHfPjGP00A5TaijFc';
...
if (isset($_POST['payment']) && $_POST['payment'] == 'posted' && floatval($_POST['amount']) > 0) {
    ...
    try {
        ...
        $response = \Stripe\Charge::create(array(
            ...
            "description" => 'Stripe Room / Tour Booking Success'
        ));
