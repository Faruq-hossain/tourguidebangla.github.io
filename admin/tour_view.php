...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">View Tour</h1>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <img src="../touruploads/<?php echo $row['room_featured_photo']; ?>" style="width:200px;">
                                </td>
                                <td><?php echo $row['room_name']; ?></td>
                                <td><?php echo $row['room_type_name']; ?></td>
                                <td>$ <?php echo $row['room_price']; ?></td>
                                <td> <?php echo $row['room_day']; ?></td>
                                <td>
                                    <a href="tour_photo.php?id=<?php echo $row['room_id']; ?>" class="btn btn-primary btn-xs">Manage Photos</a>
                                </td>
                                <td>
                                    <a href="" class="btn btn-xs btn-info" data-toggle="modal" data-target="#myModal<?php echo $i; ?>">View Details</a>
                                    <a href="tour_edit.php?id=<?php echo $row['room_id']; ?>" class="btn btn-xs btn-warning">Edit</a>
                                    <a href="tour_delete.php?id=<?php echo $row['room_id']; ?>" class="btn btn-xs btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
