...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1)
    {
        $q = $pdo->prepare("INSERT INTO category_tour (category_name) VALUES (?)");
        $q->execute([$category_name]);

        $success_message = 'Tour Category is added successfully!';
    }
}
?>
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Add Tour Category</h1>
    </div>
</div>
