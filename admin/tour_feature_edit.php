...
if(isset($_POST['form1'])) {
    ...
    $q = $pdo->prepare("UPDATE tour_feature SET 
                room_feature_name=?,
                room_feature_icon=?
    ...
    $success_message = 'Tour Feature is updated successfully!';
}
?>

<?php
$q = $pdo->prepare("SELECT * FROM tour_feature WHERE room_feature_id=?");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Tour Type</h1>
    </div>
</div>
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" method="post">
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Tour Feature Name *</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="room_feature_name" value="<?php echo $room_feature_name; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Tour Feature Icon *</label>
                        <div class="col-sm-10">
