...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1)
    {
        $q = $pdo->prepare("INSERT INTO photo_tour_category (photo_category_name) VALUES (?)");
        $q->execute([$photo_category_name]);

        $success_message = 'Photo Tour Category is added successfully!';
    }
}
?>
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Add Tour Photo Category</h1>
    </div>
</div>
