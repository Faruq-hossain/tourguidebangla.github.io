...
if(isset($_POST['form1'])) {
    ...
    $q = $pdo->prepare("UPDATE emergency SET 
                name=?, 
                address=?, 
                contact=?,
                website=?
    ...
    $success_message = 'Hospital Information is updated successfully!';
}
...
$res = $q->fetchAll();
foreach ($res as $row) {
    $slider_title = $row['name'];
    $slider_subtitle = $row['address'];
    $slider_button_text = $row['contact'];
    $slider_button_url = $row['website'];
    $slider_photo = $row['map'];
}
?>
                    ...
                    <div class="tab-pane fade in active" id="t_info">
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" value="<?php echo $slider_title; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Address</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="address" value="<?php echo $slider_subtitle; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Contact</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="contact" value="<?php echo $slider_button_text; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Website</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="website" value="<?php echo $slider_button_url; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Map</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="map" value="<?php echo $slider_button_url; ?>">
                                </div>
                            </div>
                            <div class="form-group">
