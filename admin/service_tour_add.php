...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1)
    {
        $q = $pdo->prepare("INSERT INTO service_tour (service_title,service_text) VALUES (?,?)");
        $q->execute([$service_title,$service_text]);

        $_SESSION['temp_success'] = 'Tour Service is added successfully!';
        header('location: service_tour_add.php');
        exit;
    }
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Add Tour Service</h1>
    </div>
</div>
