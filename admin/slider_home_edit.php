...
if(isset($_POST['form1'])) {
    ...
    $q = $pdo->prepare("UPDATE slider_home SET 
                slider_title=?, 
                slider_subtitle=?, 
                slider_button_text=?,
                slider_button_url=?
    ...
    $success_message = 'Slider Home Information is updated successfully!';
}
...
if(isset($_POST['form2'])) 
{
    ...
    if($valid == 1)
    {
        ...
        $final_name = 'sliderhome_'.$_REQUEST['id'].'.'.$ext;
        ...
        $success_message = 'Slider Home Photo is updated successfully!';
    }
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Home Slider</h1>
    </div>
</div>
