...
if (isset($_POST['form1'])) {
    ...
    if ($_POST['room_name'] == '') {
        $valid = 0;
        $error_message .= 'Tour Name can not be empty<br>';
    }
    ...
    if ($_POST['room_price'] == '') {
        $valid = 0;
        $error_message .= 'Tour Price can not be empty<br>';
    }
    if ($_POST['room_day'] == '') {
        $valid = 0;
        $error_message .= 'Tour Day can not be empty<br>';
    }

    if ($_POST['room_total'] == '') {
        $valid = 0;
        $error_message .= 'Tour Total can not be empty<br>';
    }

    if ($valid == 1) {

        $q = $pdo->prepare("UPDATE tour SET 
                room_name=?, 
        ...
        $success_message = 'Tour Information is updated successfully!';
    }
}
    ...
    if ($valid == 1) {
        if (isset($_POST['room_feature_ids'])) {
            ...
            foreach ($_POST['room_feature_ids'] as $value) {
                $q = $pdo->prepare("INSERT INTO tour_tour_feature (
                                room_id,
                                room_feature_id
                            ) 
                            VALUES (?,?)");
...
if (isset($_POST['form3'])) {
    ...
    if ($valid == 1) {
        ...
        unlink('../touruploads/' . $current_photo);
        $final_name = 'room_' . $_REQUEST['id'] . '.' . $ext;
        move_uploaded_file($path_tmp, '../touruploads/' . $final_name);
        ...
        $success_message = 'Tour Featured Photo is updated successfully!';
    }
}
?>
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Tour</h1>
    </div>
</div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="t_info">
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Tour Name *</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Tour Price *</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="room_price" value="<?php echo $room_price; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Tour Day *</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="room_day" value="<?php echo $room_day; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Tour Total *</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="room_total" value="<?php echo $room_total; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Tour Show on home? *</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Tour Type *</label>
                                <div class="col-sm-10">
                    ...
                    <div class="tab-pane fade" id="t_feature">
                        ...
                        <form class="form-horizontal" action="" method="post">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Select Tour Features</label>
                                <div class="col-sm-10">
                                    <?php
                                    $q = $pdo->prepare("
                                                SELECT * 
                    ...
                    <div class="tab-pane fade" id="t_photo">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img src="../touruploads/<?php echo $room_featured_photo; ?>" style="width:200px;">
                                </div>
                            </div>
                            <div class="form-group">
