...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        $q = $pdo->prepare("SHOW TABLE STATUS LIKE 'tour'");
        $q->execute();
        $result = $q->fetchAll();
        ...
        $final_name = 'tour_' . $ai_id . '.' . $ext;
        move_uploaded_file($path_tmp, '../touruploads/' . $final_name);

        $q = $pdo->prepare("INSERT INTO tour (
                        room_name,
        ...
        $q->execute([$_POST['room_name'], $_POST['room_short_description'], $_POST['room_description'], $final_name, $_POST['room_overview'], $_POST['room_facility'], $_POST['room_price'], $_POST['room_day'], $_POST['room_total'], $_POST['room_show_on_home'], $_POST['room_type_id']]);
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="room_day">
                                </div>
                            </div>
                            <div class="form-group">
