...
if(isset($_POST['form1'])) {
    ...
    $q = $pdo->prepare("UPDATE testimonial_tour SET 
    ...
    $success_message = 'Testimonial Tour Information is updated successfully!';
}
...
if(isset($_POST['form2'])) 
{
    ...
    else
    {
        ...
        {
            $valid = 0;
            $error_message .= 'Only jpg, png and gif files are allowed for testimonial tour photo<br>';
        }
    }
    ...
    if($valid == 1)
    {
        ...
        $destination = '../touruploads/'.$final_name;
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Tour Testimonial</h1>
    </div>
</div>
                    ...
                    <div class="tab-pane fade" id="t_photo">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img src="../touruploads/<?php echo $person_photo; ?>" style="width:100px;">
                                </div>
                            </div>
                            <div class="form-group">
