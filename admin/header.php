...
<head>
	...
	<title>Tour Bangla - Admin Panel</title>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<?php if ($_SESSION['user']['role_id'] == 1 || $_SESSION['user']['role_id'] == 2) : ?>
							...
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i>Tour Language <span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="language_tour_add.php">Add Tour Language</a></li>

									<li><a href="language_tour_view.php">View Tour Languages</a></li>
								</ul>
							</li>
<!-- 
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i>Emergency Service <span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href=""><i class="fa fa-files-o fa-fw"></i>Hospital<span class="fa arrow"></span></a>
										<ul><a href="hospital_add.php">Add Hospital</a></ul>
										<ul><a href="hospital_view.php">View Hospital</a></ul>
									</li>
								</ul>
								<ul class="nav nav-second-level">
									<li><a href=""><i class="fa fa-files-o fa-fw"></i>Hospital<span class="fa arrow"></span></a>
										<ul><a href="">Ambulance</a></ul>
									</li>
								</ul>
							...
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i>Tour Sliders<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="slider_tour_add.php">Add Tour Slider</a></li>

									<li><a href="slider_tour_view.php">View Tour Sliders</a></li>
								</ul>
							</li>

							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i>Home Sliders<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="slider_home_add.php">Add Home Slider</a></li>

									<li><a href="slider_home_view.php">View Home Sliders</a></li>
								</ul>
							</li>
							<li>
							...
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i>Tour Features<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="feature_tour_add.php">Add Tour Feature</a></li>
									<li><a href="feature_tour_view.php">View Tour Features</a></li>
								</ul>
							</li>
							<li>
							...
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i> Testimonials Tour<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="testimonial_tour_add.php">Add Tour Testimonial</a></li>
									<li><a href="testimonial_tour_view.php">View Tour Testimonials</a></li>
								</ul>
							</li>
							<li>
							...
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i> Service Tour<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="service_tour_add.php">Add Service</a></li>
									<li><a href="service_tour_view.php">View Services</a></li>
								</ul>
							</li>
							<li>
							...
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i>Tour Gallery<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="photo_tour_category_add.php">Add Tour Photo Category</a></li>
									<li><a href="photo_tour_category_view.php">View Tour Photo Categories</a></li>
									<li><a href="photo_tour_add.php">Add Tour Photo</a></li>
									<li><a href="photo_tour_view.php">View Tour Photos</a></li>
								</ul>
							</li>
							<li>
							...
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i>Tour Blog / Post<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="category_tour_add.php">Add Tour Category</a></li>
									<li><a href="category_tour_view.php">View Tour Categories</a></li>
									<li><a href="post_tour_add.php">Add Tour Post</a></li>
									<li><a href="post_tour_view.php">View Tour Posts</a></li>
									<li><a href="all_tour_comments.php"> Tour Comments</a></li>
									<li><a href="all_tour_replies.php"> Tour Replies</a></li>
								</ul>
							</li>
							<li>
							...
							<li>
								<a href="#"><i class="fa fa-files-o fa-fw"></i> Tour Places<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li><a href="tour_type_add.php">Add Tour Places Type</a></li>
									<li><a href="tour_type_view.php">View Tour Places Types</a></li>
									<li><a href="tour_feature_add.php">Add Tour Places Feature</a></li>
									<li><a href="tour_feature_view.php">View Tour Places Features</a></li>
									<li><a href="tour_add.php">Add Tour Places</a></li>
									<li><a href="tour_view.php">View Tour Places</a></li>
								</ul>
							</li>
							<li>
