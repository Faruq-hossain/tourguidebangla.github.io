...
if(isset($_POST['form1'])) {
    ...
    $q = $pdo->prepare("UPDATE feature_tour SET 
                feature_icon=?
                WHERE feature_id=?
            ");
    $q->execute([ 
    ...
    {
        $q = $pdo->prepare("UPDATE feature_tour_language SET 
                feature_title=?,
                feature_text=?
    ...
    $success_message = 'Feature Tour is updated successfully!';
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Tour Feature</h1>
    </div>
</div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" action="" method="post">
                            ...
                            foreach ($res as $row) {
                                ...
                                $r = $pdo->prepare("SELECT * FROM feature_tour_language WHERE lang_code=? AND feature_id=?");
                            ...
                            <?php
                            $q = $pdo->prepare("SELECT * FROM feature_tour WHERE feature_id=?");
