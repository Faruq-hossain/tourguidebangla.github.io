...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        $success_message = 'Post Tour Information is updated successfully!';
    }
}
...
if (isset($_POST['form2'])) {
    ...
    if ($valid == 1) {
        ...
        foreach ($_POST['category_ids'] as $value) {
            $q = $pdo->prepare("INSERT INTO post_tour_category (
                            post_id,
                            category_id
                        ) 
                        VALUES (?,?)");
...
if (isset($_POST['form3'])) {
    if (isset($_POST['tag_names'])) {
        foreach ($_POST['tag_names'] as $value) {
            $q = $pdo->prepare("INSERT INTO post_tour_tag (
                            post_id,
                            tag_name
                        ) 
                        VALUES (?,?)");
...
if (isset($_POST['form4'])) {
    ...
    if ($valid == 1) {
        ...
        $success_message = 'Post Tour Photo is updated successfully!';
    }
}
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    foreach ($res as $row) {
                                        ...
                                        $total = $r->rowCount();
                                    ?>
                                        <input type="checkbox" name="category_ids[]" value="<?php echo $row['category_id']; ?>" <?php if ($total) {
                                                                                                                                    echo 'checked';
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="post_tour_tag_delete.php?id=<?php echo $row['post_tag_id']; ?>&id1=<?php echo $row['post_id']; ?>" class="btn btn-sm btn-danger" onClick="return confirm('Are you sure?');">X</a></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
                    ...
                    <div class="tab-pane fade" id="t_photo">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img src="../touruploads/<?php echo $post_photo; ?>" style="width:200px;">
                                </div>
                            </div>
                            <div class="form-group">
