...
if(isset($_POST['form1'])) {
    ...
    $q = $pdo->prepare("UPDATE slider_tour SET 
                slider_title=?, 
                slider_subtitle=?, 
                slider_button_text=?,
                slider_button_url=?
    ...
    $success_message = 'Slider Tour Information is updated successfully!';
}
...
if(isset($_POST['form2'])) 
{
    ...
    if($valid == 1)
    {
        ...
        $final_name = 'slidertour_'.$_REQUEST['id'].'.'.$ext;
        ...
        $success_message = 'Slider Tour Photo is updated successfully!';
    }
...
<?php
$q = $pdo->prepare("SELECT * FROM slider_tour WHERE slider_id=?");
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Tour Slider</h1>
    </div>
</div>
                    ...
                    <div class="tab-pane fade" id="t_photo">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img src="../touruploads/<?php echo $slider_photo; ?>" style="width:200px;">
                                </div>
                            </div>
                            <div class="form-group">
