...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1)
    {
        ...
        $q = $pdo->prepare("SHOW TABLE STATUS LIKE 'testimonial_tour'");
        $q->execute();
        $result = $q->fetchAll();
        ...
        $q = $pdo->prepare("INSERT INTO testimonial_tour (person_name_designation,person_comment,person_photo) VALUES (?,?,?)");
        $q->execute([$person_name_designation,$person_comment,$final_name]);

        $success_message = 'Tour Testimonial is added successfully!';
    }
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Add Tour Testimonial</h1>
    </div>
</div>
