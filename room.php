        ...
        <div class="row">
          <div class="col-sm-12">
            <ol class="breadcrumb">
              ...
              <li class="active" style="font-weight: bold;"><?php echo $room_name; ?></li>
            </ol>
            <h1 style="font-weight: bold;font-size:large"><?php echo $room_name; ?></h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section id="reservation-form" class="mt50 clearfix">
      <div class="col-sm-12 col-md-4">
        ...
        <form class="reservation-vertical clearfix" role="form" method="post" action="">
          ...
          <h1 class="lined-heading" style="font-weight:bold;font-size:large;"><span>Reservation</span></h1>


          <div class="price">
            <h4><?php echo $room_name; ?></h4>
            BDT <?php echo $room_price; ?>,-<span> a night</span>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-7 mt50">
            <h2 class="lined-heading" style="font-weight:bold;font-size:large;"><span>Room Details</span></h2>
            <h3 class="mt50" style="font-weight:bold;font-size:large;">Features</h3>
          ...
          <div class="col-sm-5 mt50">
            ...
            <h2 class="lined-heading" style="font-weight:bold;font-size:large;"><span>Overview</span></h2>
            ...
            <div class="tab-content">
              <div class="tab-pane fade in active" id="overview">
                ...
                <p style="color: black;"><?php echo $room_overview; ?>
                  <br>
                <ul class="fa-ul">
                  <li><i class="fa-li fa fa-check-square"></i>Fabulous breakfast included</li>
                  <li><i class="fa-li fa fa-check-square"></i>Free cancellation until 23:59 on 25 January 2023</li>
                  <li><i class="fa-li fa fa-check-square"></i><b>NO PREPAYMENT NEEDED – </b>pay at the property</li>
                  <li><i class="fa-li fa fa-check-square"></i><b>Genus – </b> discount available</li>
                </ul>
...
<section class=" container ">
  ...
  <div class="card">
    <div class="card-header" style="font-weight: bold;margin-bottom:10px;font-size:20px;">
      <h6>Travel Sustainable Level 3</h6>
    </div><br><br>
    <div class="card-body">
      <blockquote class="blockquote mb-0">
        <p>This property has told us they’re making large
          investments and efforts towards sustainability by taking steps that can
          have environmental and social impact. We’ve worked with experts including
          Travalyst and Sustainalize to create the Travel Sustainable programme –
          making it easier for you to experience the world more sustainably.</p>

      </blockquote>
      <!-- Button trigger modal -->
      <a href="#" type="text" class="" data-toggle="modal" data-target="#exampleModal" style="margin-top: 30px;margin-left:22px;">
        Learn More->
      </a>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Sustainability steps</h5>
            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-6">
                  <ul class="fa-ul">
                    <li style="font-weight:bold"> <i class="fa-li fa fa-check-square"></i>Wast</li>
                    <ul>
                      <li>* Recycling bins available to guests and waste is recycled</li>
                      <li>* The property makes efforts to reduce their food wastage</li>
                      <li>* Water cooler/dispenser</li>
                      <li>* Single-use plastic miniature shampoo, conditioner, and body wash bottles not used</li>
                  ...
                  <ul class="fa-ul">
                    <li style="font-weight:bold"> <i class="fa-li fa fa-check-square"></i>Water</li>
                    <ul>
                ...
                <div class="col-md-6 offset-md-6">
                  <ul class="fa-ul">
                    <li style="font-weight:bold"><i class="fa-li fa fa-check-square"></i>Energy and greenhouse gases</li>
                    <ul>
                      <li>* Most lighting throughout property uses energy-efficient LED bulbs</li>
                      <li>* All windows are double-glazed</li>
                      <li>* Offsets a portion of their carbon footprint</li>
                      <li>* 100% renewable electricity used throughout</li>
                ...
                <div class="col-md-6 offset-md-6">
                  <ul class="fa-ul">
                    <li style="font-weight:bold"><i class="fa-li fa fa-check-square"></i>Destination and community</li>
                    <ul>
                      <li>* Invests a percentage of revenue back into community projects or sustainability projects</li>
                      <li>* Tours and activities organised by local guides and businesses offered</li>
                      <li>* Local artists are offered a platform to display their talents</li>
                      <li>* Provides guests with information regarding local ecosystems, heritage and culture, as well as visitor etiquette</li>
                ...
                <div class="col-md-6 offset-md-6">
                  <ul class="fa-ul">
                    <li style="font-weight:bold"><i class="fa-li fa fa-check-square"></i>Nature</li>
                    <ul>
                      <li>* Wild (non-domesticated) animals are not displayed/interacted with while captive on the property or harvested, consumed, or sold.</li>
                      <li>* Green spaces such as gardens/rooftop gardens on the property</li>
...
<section class="container">
  <div class="card-header" style="font-weight: bold;margin-bottom:10px;font-size:20px;">
    <h6>Hotel surroundings *</h6>
  </div><br><br>
  <div class="row">
    <div class="col-md-4 offset-md-4">
      <ul class="fa-ul">
        <li style="font-weight:bold"> <i class="fa-li fa fa-check-square"></i>What's nearby</li>
        <ul><br>
          <li>* Shahid Dr Fazle Rabbi Park--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 200 m</li>
          <li>* Hatirjheel Park--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 900 m</li>
          <li>* Apartment Recreational Ground--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            1.5 km</li>
          <li>* DIT Project Playground--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            1.6 km</li>
          <li>* Mohakhali D.O.H.S. Park--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            1.9 km</li>
          <li>* Central Mosque Grounds--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            1.9 km</li>
          <li>* sovrin kids park--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            2.1 km</li>
          <li>* Chowdhurypara Childrens' Park--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            2.1 km</li>
          <li>* Gulshan Youth Club--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            2.2 km</li>
          <li>* Baisakhi Park - Banani Society--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            2.3 km
          </li>
        </ul>
    ...
    <div class="col-md-4 offset-md-4">
      <ul class="fa-ul">
        <li style="font-weight:bold"><i class="fa-li fa fa-check-square"></i>Restaurants & cafes</li>
        <ul><br>
          <li>* RestaurantKings Kebab and Resturant--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            100 m</li>
          <li>* RestaurantFat Burger--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            200 m</li>
          <li>* RestaurantBRAC Chicken
            200 m--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>

        </ul>
      </ul><br>
      <ul class="fa-ul">
        <li style="font-weight:bold"><i class="fa-li fa fa-check-square"></i>Public transport</li>
        <ul><br>
          <li>* TrainBanani Railway Station
            --&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.9 km
          </li>
          <li>* TrainDhaka Cantonment--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            4.8 km
          </li>
    ...
    <div class="col-md-4 offset-md-4">
      <ul class="fa-ul">
        <li style="font-weight:bold"><i class="fa-li fa fa-check-square"></i>Closest airports</li>
        <ul><br>
          <li>* Hazrat Shahjalal International Airport--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
8 km</li>
          <li>* Agartala Airport--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
85 km
</li>
  ...
  <p>* All distances are measured in straight lines. Actual travel distances may vary.</p>
...
<section class="rooms mt50">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h2 class="lined-heading" style="font-weight:bold;font-size:large;"><span>Related rooms</span></h2>
      </div>
      ...
      ?>
        <div class="col-sm-4">
          <div class="room-thumb"> <img src="uploads/<?php echo $row['room_featured_photo']; ?>" alt="room 1" class="img-responsive" />
            <div class="mask">
              <div class="main">
                <h5 style="font-weight:bold;"><?php echo $row['room_name']; ?></h5>
                <div class="price">BDT <?php echo $row['room_price']; ?><span>a night</span></div>
              </div>
              <div class="content">
