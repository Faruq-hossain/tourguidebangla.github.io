      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="home.php" class="navbar-brand">
            <!-- Logo -->
            <div id="logo"> <img id="default-logo" src="images/logo2.png" alt="Starhotel" style="height:44px;"> <img id="retina-logo" src="images/logo2.png" alt="Tourguidebangla" style="height:44px;"> </div>
          </a>
        </div>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle js-activated">Pages<b class="caret"></b></a>
              <ul class="dropdown-menu">
                ...
                <li><a href="http://localhost/tourhotel\food-order">Food Order</a></li>
