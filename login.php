    ...
    <section id="contact-form" class="mt50">
      <div class="col-md-7">
        ...
        <form class="clearfix mt50" method="post" action="">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input required   placeholder="example@gmail.com" name="cust_email" type="text" class="form-control" value="">
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <a href="registration.php" type="submit" class="btn  btn-lg btn-primary" name="form_login">Registration</a>
