  ...
  <div class="bannercontainer">
    <div class="banner">
      <ul>
        ...
        <?php
        $q = $pdo->prepare("SELECT * FROM slider_home ORDER BY slider_id ASC");
        $q->execute();
        $res = $q->fetchAll();
        foreach ($res as $row) {
        ?>
          <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
            ...
            <img src="touruploads/<?php echo $row['slider_photo']; ?>" style="opacity:0;" alt="slidebg1" data-bgfit="cover" data-bgposition="left bottom" data-bgrepeat="no-repeat">
            ...
            <div class="row">
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <select class="form-control" name="room_id" id="tour">
                    <?php
                    $q = $pdo->prepare("SELECT * 
                                FROM tour t1
                                JOIN tour_type t2
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <i style="color: #ff3300;" class="fa fa-calendar infield"></i>
...
<section class="abouttour mt50" id="abouttour">
  <div class="container">
    <h1 class="lined-heading" style="font-size: 25px;font-weight:bold;"><span>About Us</span></h1>
    <div class="row align-items-center">
      <div class="col-md-4 image">
        <img src="images/about1.jpg" alt="">
      </div>
      <div class="col-md-8 info">
        <h2 style="color:darkolivegreen;font-weight:bold;">The Best Tourism Place </h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil repudiandae nam eos quo ipsum exercitationem vel dolorem tempore provident veniam.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, iste impedit alias dolorem facilis sequi explicabo deserunt incidunt maxime. Doloribus, eos illum veniam minus harum rem quia quidem esse. Eveniet, delectus ipsa. Nesciunt, vero porro?</p>
        <div class="icons">
          <a href="#" style="background: #4267B2;"><i class="fa-brands fa-facebook">facebook</i></a>
          <a href="#" style="background: #1DA1F2;"><i class="bi bi-twitter"></i></a>
          <a href="#" style="background: #C13584;"><i class="bi bi-instagram"></i></a>
          <a href="#" style="background: #FF0000;"><i class="bi bi-youtube"></i></a>
        </div>
        <br><br>
...
<!-- looking next trip for section start  -->
<?php require_once('nexttrip.php'); ?>

<!-- why choose us section starts  -->

<section class="chooseus mt50" id="chooseus">
  <div class="container">

    <h2 class="lined-heading" style="font-size: 25px;font-weight:bold;"><span>Why Choose Us</span></h2>

    <div class="box-container">

      <div class="box">
        <!-- <i class="fas fa-hotel"></i> -->
        <h3 style="color:darkolivegreen;font-weight:bold;margin-bottom:20px;">Heighest Quality</h3>
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore commodi earum, quis voluptate exercitationem ut minima itaque iusto ipsum corrupti!</p>
        <h4>____________</h4>
      </div>
      <div class="box">
        <!-- <i class="fas fa-utensils"></i> -->
        <h3 style="color:darkolivegreen;font-weight:bold;margin-bottom:20px;">Food and Drinks</h3>
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore commodi earum, quis voluptate exercitationem ut minima itaque iusto ipsum corrupti!</p>
        <h4>____________</h4>
      </div>
      <div class="box">
        <!-- <i class="fas fa-bullhorn"></i> -->
        <h3 style="color:darkolivegreen;font-weight:bold;margin-bottom:20px;">Safty Guide</h3>
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore commodi earum, quis voluptate exercitationem ut minima itaque iusto ipsum corrupti!</p>
        <h4>____________</h4>
      </div>
      <div class="box">
        <!-- <i class="fas fa-globe-asia"></i> -->
        <h3 style="color:darkolivegreen;font-weight:bold;margin-bottom:20px;">Around The World</h3>
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore commodi earum, quis voluptate exercitationem ut minima itaque iusto ipsum corrupti!</p>
        <h4>____________</h4>
      </div>
      <div class="box" style="margin-top:50px;">
        <!-- <i class="fas fa-plane"></i> -->
        <h3 style="color:darkolivegreen;font-weight:bold;margin-bottom:20px;">Fastest Travel</h3>
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore commodi earum, quis voluptate exercitationem ut minima itaque iusto ipsum corrupti!</p>
        <h4>____________</h4>
      </div>
      <div class="box" style="margin-top:50px;">
        <!-- <i class="fas fa-hiking"></i> -->
        <h3 style="color:darkolivegreen;font-weight:bold;margin-bottom:20px;">Adventures</h3>
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore commodi earum, quis voluptate exercitationem ut minima itaque iusto ipsum corrupti!</p>
        <h4>____________</h4>
      </div>
    </div>
...
<!-- looking next best trip for section start  -->
<?php require_once('besttrip.php'); ?>
...
<section class="usp mt100">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h2 class="lined-heading" style="font-size: 25px;font-weight:bold;"><span>Our Features</span></h2>
      </div>
      ...
      if (!isset($_SESSION['current_lang_code'])) {
        ...
        $lang_code = $_SESSION['current_lang_code'];
      }
      ?>
      <?php
      $q = $pdo->prepare("SELECT * 
                    ...
                    WHERE t1.lang_code=? ORDER BY t1.fl_id ASC");
      $q->execute([$lang_code]);
      $res = $q->fetchAll();
      foreach ($res as $row) {
      ?>
        <div class="col-sm-3 bounceIn appear" data-start="0">
          <div class="box-icon">
            <div class="circle"><i class="fa <?php echo $row['feature_icon']; ?> fa-lg"></i></div><br><br>
            <h3 style="font-size:17px;font-weight:bold;margin-bottom:10px;"><?php echo $row['feature_title']; ?></h3>
            <p>
...
<!-- <div class="container">
  ...
  <section class="about mt100">
    <div class="col-md-6">
      <h2 class="lined-heading bounceInRight appear" data-start="800"><span>Hotel Features</span></h2>
      ...
      ?>
        <div class="col-sm-3 bounceIn appear" data-start="0">
          <div class="box-icon">
            <div class="circle"><i class="fa <?php echo $row['feature_icon']; ?> fa-lg"></i></div><br><br><br><br><br>
  ...
  <section class="about mt100">
    <div class="col-md-6">
      <h2 class="lined-heading bounceInRight appear" data-start="800"><span>Tour Features</span></h2>
      ...
      <ul class="nav nav-tabs">
        ...
        <?php
        if (!isset($_SESSION['current_lang_code'])) {
          $q = $pdo->prepare("SELECT * FROM language_tour WHERE lang_default=?");
          $q->execute(['default']);
          $res = $q->fetchAll();
          foreach ($res as $row) {
            $lang_code = $row['lang_code'];
        ...
        <?php
        $q = $pdo->prepare("SELECT * 
                    FROM feature_tour_language t1
                    JOIN feature_tour t2
                    ON t1.feature_id = t2.feature_id
                    WHERE t1.lang_code=? ORDER BY t1.fl_id ASC");
        $q->execute([$lang_code]);
        $res = $q->fetchAll();
...
<section class="parallax-effect mt100">
  <div id="parallax-image" style="background-image: url(images/parallax/parallax-01.jpg);">
    <div class="color-overlay fadeIn appear" data-start="600">
      <div class="container">
        <div class="content">
          <h3 style="color: #ff3300;" class="text-center"><i class="fa fa fa-star-o"></i> Tour Guid Bangla</h3>
          <p style="color: #ff3300;" class="text-center">An Exceptional Tour Website!
            <br>
            <a style="background-color: #ff3300;" href="blog.php" class="btn btn-default btn-lg mt30">Checkout the blog</a>
          </p>
        </div>
      </div>
    </div>
...
<section class="gallery-slider mt100">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="lined-heading" style="font-size: 25px;font-weight:bold;"><span>Gallery</span></h2>
      </div>
    </div>
  </div>
...
<!-- <section class="gallery-slider mt100">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="lined-heading"><span>Gallery Tour</span></h2>
      </div>
    </div>
  </div>
  <div id="owl-gallery" class="owl-carousel">
    ...
    foreach ($res as $row) {
    ?>
      <div class="item"><a href="../touruploads/<?php echo $row['photo_name']; ?>" data-rel="prettyPhoto[gallery1]"><img src="touruploads/<?php echo $row['photo_name']; ?>" alt=""><i class="fa fa-search"></i></a></div>
    <?php
    }
    ?>
  </div>
...
<!-- blogfor section start  -->
<?php require_once('all_division_places/index_popular_Tour_place2.php'); ?>

<br><br><br><br>
<!-- article trip for section start  -->
<?php require_once('articletrip.php'); ?>
...
<div class="container">
  <div class="row">
    ...
    <section class="testimonials mt100">
      <div class="col-md-6">
        <h2 class="lined-heading bounceInLeft appear" data-start="0" style="font-size: 25px;font-weight:bold;"><span>What Other Visitors Experienced</span></h2>
        <div id="owl-reviews" class="owl-carousel">
          ...
          <div class="item">
            ...
            $i = 0;
            $flag = 0;
            $q = $pdo->prepare("SELECT * FROM testimonial_tour ORDER BY testimonial_id ASC");
            $q->execute();
            $res = $q->fetchAll();
            foreach ($res as $row) {
              $i++;
            ...
            ?>
              <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-2 col-xs-12"> <img src="touruploads/<?php echo $row['person_photo']; ?>" alt="Review 1" class="img-circle" /></div>
                <div class="col-lg-9 col-md-8 col-sm-10 col-xs-12">
                  <div class="text-balloon">
                    <?php echo $row['person_comment']; ?>
                    <span><?php echo $row['person_name_designation']; ?></span>
    ...
    <section class="about mt100">
      <div class="col-md-6">
        <h2 class="lined-heading bounceInRight appear" data-start="800" style="font-size: 25px;font-weight:bold;"><span>Hotel Services</span></h2>
        ...
        <h2 class="lined-heading bounceInRight appear" data-start="800" style="font-size: 25px;font-weight:bold;"><span>Tour Services</span></h2>
        ...
        <ul class="nav nav-tabs">
          ...
          <?php
          $i = 0;
          $q = $pdo->prepare("SELECT * FROM service_tour ORDER BY service_id ASC");
          $q->execute();
          $res = $q->fetchAll();
          foreach ($res as $row) {
            $i++;
          ?>
            <li <?php if ($i == 1) {
                  echo 'class="active"';
                } ?>><a href="#abcd<?php echo $i; ?>" data-toggle="tab"><?php echo $row['service_title']; ?></a></li>
          <?php
          }
          ?>
