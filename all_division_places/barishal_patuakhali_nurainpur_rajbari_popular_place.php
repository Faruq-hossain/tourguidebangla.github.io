...
<head>
    <title>Nurainpur Rajbari Most Popular Place in Bangladesh</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <p style="margin-top:15px;">
                                                <b>Nurainpur Rajbari</b>
                                                Sis situated in Bauphal, Patuakhali. Patuakhali has eight
                                                other landmarks recognized in addition to this one. This district
                                                also has six other attractions classified in different categories.
                                                The exact
                                                location of Nurainpur Rajbari is shown on the map above.
                                            </p>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">More Landmarks Tourist Spot Patuakhali City in Barisal Division</h2>

                                    </div>
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">Outside of barishal, you can find the following
                                            Landmarkss Patuakhali. They are listed in descending order of distance
                                            from Patuakhali. </h4>
                                    </div>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Nurainpur Rajbari Patuakhali city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_patuakhali_nurainpur_rajbari_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Nurainpur Rajbari, <a href="barishal_patuakhali_popular_place.php"> Patuakhali</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">0 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_patuakhali_kuthibari_popular_place.php"> <img style="height:100px;width:100px;" src="images/Kuthibari of Ghaseti Begum.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_bhola_central_saheed_minar_popolar_place.php"> <img style="height:100px;width:100px;" src="images/Central Saheed Minar.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">30.8 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">21 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">21.7 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">24.1 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_patuakhali_rajeswar_roy_popular_place.php"> <img style="height:100px;width:100px;" src="images/Rajeswar Roy Chowdhury Bhaban.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_patuakhali_chakamaiya_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Chakamaiya Union and Kalapara Link Bridge, <a href="#">Barguna</a> </h2>
                                                </a>
                                                <a href="#">
