...
<head>
    <title>Modern Fantasy Kingdom Most Popular Place in Bangladesh</title>
...
<body>
    ...
    <section id="#" class="container list-group list-group-flush" style="margin-bottom:-100px">
        ...
        <div class="page-content" style="margin-top:-20px;margin-bottom:-10px;height: auto !important; min-height: 0px !important;">
            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        <a href="dhaka_shariatpur_popular_place.php">Shariatpur</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        <a href="dhaka_shariatpur_parks_popular_place.php">Parks</a>
                    </li>
                    <li class="active" style="font-size:15px;">
        ...
        <!-- <h3 style="text-align: center;">this all photos are dhaka division</h3> -->
        <!-- <hr class="mb-5" /> -->
        <!-- <hr class="mb-5" />
        <br><br><br><br> -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Chandra-Mahal Road<br> Bagerhat
                                            ...
                                            <hr>
                                            <b style="font-size:15px;">Type:</b> <a style="font-size:15px;" href="dhaka_shariatpur_parks_popular_place.php">Parks</a>

                                            <!-- <a style="font-size:15px;" href="dhaka_dhaka_parks_popular_place.php">Museum, </a> -->

                                            <hr>
                                            <div class="row" style="font-size:15px;">

                                                <div class="col-xs-6">
                                                    <i class="fa fa-facebook-square" title="Facebook"></i> <a href="https://www.facebook.com/ModernFantasyKingdom/" target="_blank" title="Facebook page of Bibichini Shahi Mosque" rel="noopener nofollow external"> Facebook Page </a>01715-313326
                                                </div>
                                                <!--   <div class="col-xs-6">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Modern Fantasy Kingdom</b>
                                                Naria, Shariatpur is the location. Shariatpur's only amusement park is listed here. This
                                                district also has nine attractions listed in other categories. The exact location of Modern
                                                Fantasy Kingdom can be found on the map above. If you require any additional
                                                information on Modern Fantasy Kingdom that is not provided here, please call 01715-313326.
                                            </h4>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">More parks Tourist Spot shariatpur City in dhaka Division</h2>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Modern Fantasy Kingdom bagerhat city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        <h2>Nearby parks in Shariatpur city</h2>
                                        <h4>Following is a list of other parks found within
                                            few kilometers of Modern Fantasy Kingdom.
                                            You may also <a href="khulna_shariatpur_parks_popular_place.php">view all parks in Shariatpur, dhaka Division.</a></h4>
                                    </div>
                                    <br>
