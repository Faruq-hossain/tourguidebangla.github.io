                                ...
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <p style="margin-top:15px;">
                                                In Barguna, there are 5 natural attractions. This represents
                                                more than half of all tourist attractions in this district.
                                                On this page, you may select from a list of all types of
                                                Barguna attractions.
                                            </p>
                                    ...
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">The following is a list of all the
                                            natural attractions in Barguna. The <a href="#">natural attractions</a> are
                                    ...
                                    <div class="row" style="margin-bottom:15px;">
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="barishal_barguna_haringhat_forest_park_popular_place.php"><img style="height:100px;width:100px;" src="images/Haringhata Forest Eco Park1.jfif" class=" card-img-top" alt="..."></a>
                                                    </div>
                                                    <a href="barishal_barguna_haringhat_forest_park_popular_place.php">
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">More Nature Attractions Tourist Spot Barguna City in Barisal Division</h2>
                                    ...
                                    <div class="row" style="margin-bottom:15px;">
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 25.7 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="#"><img style="height:100px;width:100px;" src="images/Sunset Point.jpg" class=" card-img-top" alt="..."></a>
                                                    </div>
                                                    ...
                                                    <a href="barishal_patuakhali_sunset_point_n_popular_place.php">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 27.3 Kilometers</p>
                                                    </a>
                                            ...
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="barishal_patuakhali_lebur_bon_n_popular_place.php">
                                                        <h2 style="font-weight:bold;font-size:15px;" class="card-title">Lebur Bon
                                                        </h2>
                                                    </a>

                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 28.2 Kilometers</p>
                                                    </a>
                                                    <p>Latachapli, Kuakata, Patuakhali</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 30.7 Kilometers</p>
                                                    </a>
                                                    <p>Kuakata, Patuakhali</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 31.8 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="barishal_patuakhali_kuakata_sea_n_popular_place.php"> <img style="height:100px;width:100px;" src="images/Kuakata Sea Beach.jpg" class=" card-img-top" alt="...">
                                                        </a>
                                                    </div>
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 33.3 Kilometers </p>
                                                    </a>
                                                    <p>Patuakhali</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="barishal_patuakhali_laukathi_wapda_colony_dighi_n_popular_place.php"> <img style="height:100px;width:100px;" src="images/Laukathi Wapda Colony Dighi.jpg" class=" card-img-top" alt="...">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="khulna_bagerhat_sundarban_sildlife_sanctuary_popular_place.php"> <img style="height:100px;width:100px;" src="images/Sundarban Wildlife Sanctuary.jpg" class=" card-img-top" alt="...">
                                                        </a>
                                                    </div>
                                                    <a href="khulna_bagerhat_sundarban_sildlife_sanctuary_popular_place.php">
                                                        <h2 style="font-weight:bold;font-size:15px;" class="card-title">Sundarban Wildlife Sanctuary</h2>
                                                    </a>
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 30.6 Kilometers</p>
                                                    </a>
                                                    <p>Bagerhat</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="#"> <img style="height:100px;width:100px;" src="images/Jamtola Beach.jpg" class=" card-img-top" alt="...">
                                                        </a>
                                                    </div>
                                                    <a href="#">
                                                        <h2 style="font-weight:bold;font-size:15px;" class="card-title">Jamtola Beach</h2>
                                                    </a>
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 40.5 Kilometers</p>
                                                    </a>
                                                    <p>Bagerhat</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="khulna_bagerhat_parer_haat_zamindar_bari_popular_place.php"> <img style="height:100px;width:100px;" src="images/Katka Beach.jpg" class=" card-img-top" alt="...">
                                                        </a>
                                                    </div>
                                                    <a href="khulna_bagerhat_parer_haat_zamindar_bari_popular_place.php">
                                                        <h2 style="font-weight:bold;font-size:15px;" class="card-title">Parer Haat Zamindar Bari</h2>
                                                    </a>
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 44.2 Kilometers</p>
                                                    </a>
                                                    <p>Katka, Bagerhat</p>
                                                </div>
                                            </div>
                    ...
                    <div class="sidebar">
                        <div class="row">
                                ...
                                <div class="sidebar-item recent-posts">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Nathpotty Lake2.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Nathpotty Lake</h2>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        <h2>Top Barguna city Nature Attractions</h2>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Haringhata Forest Eco Park2.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Haringhata Forest Eco Park
                                                    </h2>
                                                </a>
                                                <!-- <p>Barguna Sadar, Barguna
                                                </p> -->
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Laldia Forest2.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Laldia Forest
                                                    </h2>
                                                </a>
                                                <!-- <p>Barguna Sadar, Barguna
                                                </p> -->
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Fatrar Bon (Forest) & Eco Park1.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Fatrar Bon (Forest) & Eco Park</h2>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Sonakata Sea Beach.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Sonakata Sea Beach</h2>
