                                ...
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="down-content" id="#">
                                            <h2 style="margin-left: -30px;">Discover Landmarks Tourist places Barguna city in Barisal Division.</h2>
                                        </div>
                                        <div class="box_sundar">
                                            <!-- <h4>Sundarban</h4> -->
                                            <p style="margin-top:15px;">
                                                In Barguna, there are three landmarks. This accounts for more than one-third of all tourist attractions in this
                                                district. On this page, you may select from a list of all types
                                                of Barguna attractions.
                                            </p>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">Top Landmarks Tourist Spot Barguna City in Barisal Division</h2>

                                    </div>
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">The following is a list of all the landmarks in Barguna.
