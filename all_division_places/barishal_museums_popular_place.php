            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        <a href="barishal_museums_popular_place.php">Barishal Division</a>
                    </li>
                </ol>
            </div>
                                ...
                                <div class="row" style="margin-bottom:15px;">
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/barishal2.png" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/barishal4.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/barishal3.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/pirojpur1.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                    ...
                    <div class="sidebar">
                        <div class="row">
                            ...
                            <div class="col-lg-12" id=moreplace>
                                ...
                                <ul class="cat-filter">
                                    <li title="4 amusement parks are listed in Barisal Division."><a href="barishal_museums_popular_place.php/">Museums</a> <span class="count">(4)</span></li>
                                    <li title="4 museums are listed in Barisal Division."><a href="/barisal-division/museums/">Parks</a> <span class="count">(4)</span></li>
                                    <li title="44 landmarks are listed in Barisal Division."><a href="/barisal-division/landmarks/">Landmarks</a> <span class="count">(44)</span></li>
                                    <li title="25 nature attractions are listed in Barisal Division."><a href="/barisal-division/nature-attractions/">Nature Attractions</a> <span class="count">(25)</span></li>
                                </ul>
                            </div>
