                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <p style="margin-top:15px;">
                                                Haringhata Forest Eco Park can be found in Patharghata, Barguna.
                                                In addition to this ecological site, there are four others
                                                mentioned in Barguna. This district also has three attractions
                                                listed in other categories. The exact position of Haringhata
                                                Forest Eco Park may be found on the map above.
                                            </p>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Haringhata Forest Eco Park Barguna city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="Laldia Forest1.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 1.1 Kilometers
                                                    </h2>
                                                </a>
