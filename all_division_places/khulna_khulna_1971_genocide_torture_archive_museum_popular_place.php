...
<head>
    <title>1971 : Genocide-Torture Archive & Museum Most Popular Place in Bangladesh</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Munshipara 1st Lane<br>Munshipara<br> Khulna - 9100
                                            ...
                                            <div class="row" style="font-size:15px;">
                                                ...
                                                <div class="col-xs-6">
                                                    <i class="fa fa-facebook-square" title="Facebook"></i> <a href="#" target="_blank" title="Facebook page of Bibichini Shahi Mosque" rel="noopener nofollow external"> 041-733788</a>
                                                </div>
                                                <!--   <div class="col-xs-6">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>1971 : Genocide-Torture Archive & Museum</b>
                                                Munshipara 1st Lane, Munshipara, Khulna - 9100 is the address.
                                                In addition to this museum, Khulna has another museum. This
                                                district also has fifteen attractions classified in other
                                                categories. The exact location of 1971: Genocide-Torture
                                                Archive & Museum may be found on the map above. If you require
                                                any additional information on 1971: Genocide-Torture Archive
                                                & Museum that is not provided here, please contact 041-733788.
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> 1971 : Genocide-Torture Archive & Museum khulna city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <h4>Following is a list of other Museum found within
                                            few kilometers of 1971 : Genocide-Torture Archive & Museum.
