...
<head>
    <title>Butterfly Park Most Popular Place in Bangladesh</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    15 Naval Academy Road (Beside Airport)
                                            ...
                                            <div class="row" style="font-size:15px;">
                                                <div class="col-xs-6">
                                                    <i class="fa fa-facebook-square" title="Facebook"></i> <a href="https://www.facebook.com/ButterflyParkBangladesh/" target="_blank" title="Facebook page of Bibichini Shahi Mosque" rel="noopener nofollow external">Facebook Page</a>
                                                </div>
                                                <div class="col-xs-6">
                                                    <i class="icon icon-globe" title="Wikipedia"></i> <a href="#" target="_blank" title="Wikipedia reference of Bibichini Shahi Mosque" rel="noopener nofollow external">01811-444270</a>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Butterfly Park</b>
                                                Chittagong's address is 15 Naval Academy Road (next to the airport). In addition to this
                                                amusement park, there are three more listed in Chittagong. This district also has thirty
                                                attractions classified in other categories. The exact position of Butterfly Park can be
                                                found on the map above. If you require any additional
                                                information on Butterfly Park that is not provided here, please call 01811-444270.
                                    ...
                                    <div class="down-content" id="#">
                                        ...
                                        <div class="more-info-item">
                                            ...
                                            Sunday to Saturday: 9:00 am - 11:00 pm<br>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;">Butterfly Park chitta city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">15.4 Kilometers
                                                    </h2>
                                                </a>
