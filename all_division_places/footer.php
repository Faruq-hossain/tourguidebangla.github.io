  ...
  <div class="container" >
    <div class="row" style="margin-top:50px;">
      <div class="col-md-3 col-sm-3">
        <h4 style="font-size:20px;color:#898989;font-weight:bold;margin-bottom:20px;">About Tour Guide Bangla</h4>
      ...
      <div class="col-md-3 col-sm-3">
        <h4 style="font-size:20px;color:#898989;font-weight:bold;margin-bottom:20px;">Recieve our newsletter</h4>
      ...
      <div class="col-md-2 col-sm-2">
        <h4 style="font-size:20px;color:#898989;font-weight:bold;margin-bottom:20px;">Hotel blog</h4>
        <ul>
      ...
      <!-- Tour blog -->
      <div class="col-md-2 col-sm-2">
        <h4 style="font-size:20px;color:#898989;font-weight:bold;margin-bottom:20px;">Tour blog</h4>
        <ul>
      ...
      <div class="col-md-2 col-sm-2">
        <h4 style="font-size:20px;color:#898989;font-weight:bold;margin-bottom:20px;">Address</h4>
        <address>
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="row" style="font-size:15px;">
        <div style="color:#fff;" class="col-xs-6"> <?php echo $footer_copyright; ?> </div>
