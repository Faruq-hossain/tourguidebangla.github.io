                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="down-content" id="#">
                                            <h2 style="margin-left: -30px;">Discover Landmarks in Barisal Division.</h2>
                                        </div>
                                        <div class="box_sundar">
                                            <!-- <h4>Sundarban</h4> -->
                                            <p style="margin-top:15px;">
                                                <b>Barisal Division contains 44 landmarks.</b> This represents around half
                                                of all tourist attractions listed in this region. <a href="#">Barisal</a>,
                                                <a href="#">Jhalokati</a>,
                                                <a href="#">Patuakhali</a>, <a href="#">Pirojpur</a>, and Bhola are the top districts in Barisal
                                                Division having popular landmarks. On this page, you can discover
                                                a list of all types of Barisal Division attractions to pick from.
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">Top 10 Tourist Landmarks in Barisal Division</h2>

                                    </div>
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">Visit the most
                                            popular tourist <b>Landmarks in Barisal Division.</b>
                                            Click on a <b>Landmarks</b> below for more information.</h4>
                                    </div>
                                ...
                                <div class="row" style="margin-bottom:15px;">
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Sreerampur Zamidar Bari1.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Sreerampur Old(Prachin) Mosque1.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Parer Haat Zamindar Bari1.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Kirtipasha Zamindar Bari1.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Mia Bari Mosque1.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Jacob Watchtower1.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Bibichini Shahi Mosque1.jpg" class=" card-img-top" alt="...">
                                                </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Guthia Baitul Aman Jame Masjid Complex1.png" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Lakutia Zamindar Bari1.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Birshreshtho Captain Mohiuddin Jahangir Memorial Museum1.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;">Look for Parks by City</h2>
                                </div>
                                <div class="box_sundar">
                                    <h4 style="margin-top:20px;margin-bottom: 25px;">There are <b>Landmarks
                                            in 6 districts in Barisal Division</b>. Explore the Landmarks in the
                                        following districts to learn more about the Barisal Division.
                    ...
                    <div class="sidebar">
                        <div class="row">
                            ...
                            <div class="col-lg-12" id=moreplace>
                                ...
                                <button class="btn-light" type="submit"><a href="barishal-division_popular_place.php">View All</a></button>
                            </div>
