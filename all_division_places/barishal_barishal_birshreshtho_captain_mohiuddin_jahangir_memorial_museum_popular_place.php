        ...
        <div class="page-content" style="margin-top:-20px;margin-bottom:-10px;height: auto !important; min-height: 0px !important;">
            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        Birshreshtho Captain Mohiuddin Jahangir Memorial Museum
                    </li>
                </ol>
            </div>
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Rahimganj<br>Babuganj<br> Barisal
                                            ...
                                            <hr>
                                            <b style="font-size:15px;">Type:</b> <a style="font-size:15px;" href="barishal_barishal_museums_popular_place.php">Museum, </a><a style="font-size:15px;" href="barishal_barishal_landmarks_popular_place.php">Landmark</a>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Birshreshtho Captain Mohiuddin Jahangir Memorial Museum </b>
                                                is situated in Rahimganj, Babuganj, and Barisal. In addition to
                                                this museum, there are two others in Barisal. This district also
                                                has eighteen attractions classified in other categories.
                                                The exact location of Birshreshtho Captain
                                                Mohiuddin Jahangir Memorial Museum may be found on the map above.
                                            </h4>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <p>Following is a list of other landmarks found within
                                            few kilometers of Birshreshtho Captain Mohiuddin Jahangir Memorial Museum .
                                            You may also <a href="barishal_barishal_landmarks_popular_place.php">view all landmarks in Barguna, Barisal Division.</a></p>
                                    </div>
                                    <br>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Sher-e-Bangla Memorial Museum, <a href="#">Barisal</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barishal to 13.9 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Barisal Divisional Museum2.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barisal Divisional Museum, <a href="#">Barisal</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barishal to 20.1 Kilometers
                                                    </h2>
                                                </a>
