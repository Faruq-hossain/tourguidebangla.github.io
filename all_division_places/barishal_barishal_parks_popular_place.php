...
<head>
    <title> Barisal parks Most Popular Place in Bangladesh</title>
                                ...
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="down-content" id="#">
                                            <h2 style="margin-left: -30px;">Discover parks Tourist places barishal city in Barisal Division.</h2>
                                        </div>
                                        <div class="box_sundar">
                                            <!-- <h4>Sundarban</h4> -->
                                            <h4 style="margin-top:15px;">
                                                There is 1 amusement park found in Barisal. This is 5% of all the
                                                tourist places listed in this district. You may find a list of
                                                all categories of Barisal attractions on this page to choose from.
                                            </h4>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">Top parks Tourist Spot barishal City in Barisal Division</h2>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">More parks Tourist Spot barshal city in Barisal Division</h2>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">28.7 Kilometers </p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">38.1 Kilometers </p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text"> 60.1 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text"> 60.7 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text"> 70.7 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text"> 78 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">84 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text"> 85.1 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text"> 101 Kilometers</p>
                                                    </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="sidebar-item categories">
                                    <div class="sidebar-heading">
                                        <h2>Barguna Google map with parks</h2>
                                    </div>
                                    <div class="content">
                                        <div id="map"></div>
                                    </div>
                                ...
                                <div class="sidebar-item recent-posts">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_barishal_planet_park_popular_place.php"> <img style="height:100px;width:100px;" src="images/Planet Park1.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="barishal_barishal_planet_park_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Planet Park
                                                    </h2>
                                                </a>
                                                <!-- <p>Barguna Sadar, Barguna
                                                </p> -->
