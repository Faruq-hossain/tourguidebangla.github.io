                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Patuakhali Sadar<br> Patuakhali
                                                </strong>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <p style="margin-top:15px;">
                                                <b>Rajeswar Roy Chowdhury Bhaban</b>Patuakhali Sadar is
                                                located in Patuakhali. Patuakhali has eight other landmarks
                                                in addition to this one. This district also has six attractions
                                                listed in other categories. The exact position of
                                                Rajeswar Roy Chowdhury Bhaban can be found on the map above.
                                            </p>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Rajeswar Roy Chowdhury Bhaban Patuakhali city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <p>Following is a list of other landmarks found within few kilometers
                                            of Rajeswar Roy Chowdhury Bhaban.
                                    ...
                                    <!-- <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Rajeswar Roy Chowdhury Bhaban.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Rajeswar Roy Chowdhury Bhaban, <a href="#">Patuakhali</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 2.3 Kilometers
                                                    </h2>
                                                </a>
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_patuakhali_sreerampur_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Sreerampur Zamidar Bari, <a href="#">Patuakhali</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 2.5 Kilometers
                                                    </h2>
                                                </a>
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_patuakhali_sreerampur_old_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Sreerampur Old(Prachin) Mosque, <a href="#">Patuakhali</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 0 Kilometers
                                                    </h2>
                                                </a>
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_barguna_bibicini_shahi_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Bibichini Shahi Mosque, <a href="#">Patuakhali</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 20.3 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_patuakhali_sutabari_popular_place.php"> <img style="height:100px;width:100px;" src="images/Sutabaria Dayamayee Mandir2.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Kuthibari of Ghaseti Begum.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Kuthibari of Ghaseti Begum, <a href="#">Patuakhali</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 24.1 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_patuakhali_nurainpur_rajbari_popular_place.php"> <img style="height:100px;width:100px;" src="images/Nurainpur Rajbari.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="barishal_patuakhali_nurainpur_rajbari_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Nurainpur Rajbari, <a href="#">Patuakhali</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 24.1 Kilometers
                                                    </h2>
                                    ...
                                    <!-- <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_patuakhali_chakamaiya_popular_place.php"> <img style="height:100px;width:100px;" src="images/Chakamaiya Union and Kalapara Link Bridge.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="barishal_patuakhali_chakamaiya_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Chakamaiya Union and Kalapara Link Bridge, <a href="#">Patuakhali</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 20.7 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_patuakhali_payra_seaport_popular_place.php"> <img style="height:100px;width:100px;" src="images/Payra Seaport.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_patuakhali_kuakata_buddhist_popular_place.php"> <img style="height:100px;width:100px;" src="images/Kuakata Buddhist Temple.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
