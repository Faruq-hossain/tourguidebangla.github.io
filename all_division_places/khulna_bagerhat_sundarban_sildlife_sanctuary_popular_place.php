                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Sundarban Wildlife Sanctuary</b>Bagerhat is the location.
                                                Bagerhat has seven other nature attractions listed in addition
                                                to this one. This district also has eleven attractions classified
                                                in other categories. The exact position of Sundarban Wildlife
                                                Sanctuary may
                                                be found on the map above. If you require any additional
                                                information on Sundarban Wildlife Sanctuary that is not

                                                provided here, please contact 01715-093412.
                                            </h4>
                                ...
                                <div class="sidebar-item recent-posts">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Katka Beach.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Katka Beach, <a href="#">Bagerhat</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 5.5 Kilometers
                                                    </h2>
                                                </a>
