...
<head>
    <title>Bagerhat Museum Most Popular Place in Bangladesh</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Old Rupsa Bagerhat Road<br> Bagerhat
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Bagerhat Museum</b>
                                                It is situated on the southern corner of Bagerhat's Shat
                                                Gambuj Masjid (60 dome mosque). It was created in 1995
                                                to honor Khan Jahan Ali and the Muslim culture of the region.
                                                <br><br>
                                                The museum was created to display relics collected in the
                                                Bagerhat region. Khan Jahan Ali built this territory during
                                                the time of Bengal king Nasiruddin Mahmud Shah (1442-1459).
                                                Khan Jahan Ali most likely introduced Islam to this region.
                                                He then gave the region the name Khalifat-i-Avad. He built
                                                numerous roads, marketplaces, mosques, and tanks for the
                                                sake of the people. It is said that this great guy began
                                                digging 360 lakes in 360 mosques
                                                around the entire area, beginning at Jessore's Baro Bazar.
                                                <br><br>
                                                In order to preserve Khan Jahan Ali's memory, the Museum was
                                                erected in 1995 with the assistance of a UNESCO subsidy.
                                                This south-facing museum building houses three galleries
                                                that house numerous treasures of Islamic culture as well as
                                                several antique plaques. It is worthwhile to visit this museum
                                                to learn about the history of Islam and Khan Jahan Ali's role
                                                to the propagation of Islam in this region. Because both the
                                                Sat Gambuj Masjid and this museum
                                                are located in the same compound, visitors to both are welcome.
                                                <br><br>
                                                At the museum's entrance, there is a ticket counter.
                                                Except for children under
                                                the age of five, everyone must purchase an admission ticket.
                                                <br><br>
                                                Bagerhat's single museum is listed here. This district also
                                                has eighteen attractions classified in other categories. The
                                                exact position of Bagerhat Museum may be found on the map above.
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Bagerhat Museum khulna city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <h4>Following is a list of other landmarks found within
                                            few kilometers of Bagerhat Museum.
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href=".php"> <img style="height:100px;width:100px;" src="images/1971 Genocide-Torture Archive & Museum.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href=".php">
