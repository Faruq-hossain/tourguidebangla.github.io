...
<head>
    <title>Sheikh Rasel Poura Shishu Park Most Popular Place in Bangladesh</title>
        ...
        <div class="page-content" style="margin-top:-20px;margin-bottom:-10px;height: auto !important; min-height: 0px !important;">
            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        <a href="dhaka_gopalganj_popular_place.php">gopalganj</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        <a href="dhaka_gopalganj_parks_popular_place.php">Parks</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Gopalganj-Tungipara Road<br>Tungipara<br> Gopalganj
                                            ...
                                            <hr>
                                            <b style="font-size:15px;">Type:</b> <a style="font-size:15px;" href="dhaka_gopalganj_parks_popular_place.php">Parks</a>
                                            ...
                                            <div class="row" style="font-size:15px;">
                                                ...
                                                <div class="col-xs-6">
                                                    <i class="fa fa-facebook-square" title="Facebook"></i> <a href="https://www.facebook.com/pages/Sheikh-Rasel-Shishu-Park/921731761229622" target="_blank" title="Facebook page of Bibichini Shahi Mosque" rel="noopener nofollow external"> Facebook Page </a>
                                                </div>
                                                <!--   <div class="col-xs-6">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Sheikh Rasel Poura Shishu Park</b>
                                                Tungipara, Gopalganj, is located on the Gopalganj-Tungipara Road. This is the only listed
                                                amusement park in Gopalganj. This district also has nine attractions listed in other
                                                categories.
                                                The exact position of Sheikh Rasel Poura Shishu Park may be found on the map above.
                                            </h4>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">More parks Tourist Spot gopalganj City in dhaka Division</h2>
                                    ...
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">Outside of gopalgonj, you can find the following
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Sheikh Rasel Poura Shishu Park bagerhat city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        <h2>Nearby parks in gopalganj city</h2>
                                        <h4>Following is a list of other parks found within
                                            few kilometers of Sheikh Rasel Poura Shishu Park.
                                            You may also <a href="dhaka_gopalganj_parks_popular_place.php">view all parks in gopalganj, dhaka Division.</a></h4>
                                    </div>
                                    <br>
