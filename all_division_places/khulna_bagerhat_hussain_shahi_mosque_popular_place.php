...
<head>
    <title>Hussain Shahi Masjid Most Popular Place in Bangladesh</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Hussain Shahi Masjid</b>
                                                Bagerhat is the location. Bagerhat has eight other landmarks in
                                                addition to this one. This district also has 10 attractions listed
                                                in other categories. The
                                                exact position of Hussain Shahi Masjid may be found on the map above.
                                            </h4>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Hussain Shahi Masjid Bagerhat city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">2.9 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">0.4 Kilometers
