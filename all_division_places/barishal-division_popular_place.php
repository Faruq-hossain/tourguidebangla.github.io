                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="down-content" id="#">
                                            <h2 style="margin-left: -30px;">Barisal Division Popular Tourist Places in Bangladesh</h2>
                                        </div>
                                        <div class="box_sundar">
                                            <!-- <h4>Sundarban</h4> -->
                                            <p style="margin-top:15px;">
                                                In Barisal Division, there are approximately 200 touristy spots.
                                                This represents 8% of all tourist attractions in Bangladesh.
                                                The following are the top districts in Barisal Division
                                                with major tourism destinations:
                                                <a href="#">Barisal</a>, <a href="#">Patuakhali</a>,
                                                <a href="Jhalokati">Jhalokati</a>,<a href="#">Pirojpur</a>, and
                                                <a href="Barguna">Barguna</a>,

                                                <br><a href="#">landmarks</a>,
                                                <a href="#">nature attractions</a>,
                                                are the major districts.There are also <a href="#">museums</a>
                                                listed in the Barisal Division. This article contains
                                                a list of all types of Barisal Division attractions.
                                                Click on a category to view all Barisal Division
                                                attractions of that type.
                                                <br><br>

                                                Barisal is one of Bangladesh's eight administrative divisions,
                                                located in the country's south. The division serves as a
                                                gateway to the region of South Bengal.

                                                <br><br>

                                                Barisal was established as a division in 1993, with six
                                                districts, one of which being <a href="#">Barisal</a>. This division
                                                includes the districts of <a href="#">Barisal</a>,
                                                <a href="#">Barguna</a>,
                                                <a href="#">Bhola</a>,
                                                <a href="#">Jhalokati</a>,
                                                <a href="#">Patuakhali</a>, and
                                                <a href="#">Pirojpur</a>. Until 1993,
                                                all of these districts were under the administration
                                                of the <a href="#">Khulna division</a>.

                                                <br><br>
                                                Barisal district was formed of the subdivisions of Barisal Sadar,
                                                Barguna, Jhalakati, Pirojpur, and Bhola. All of these
                                                subdivisions were elevated to the status of districts
                                                in 1984, and the territory of the greater Barisal
                                                district was reduced. Barisal was later declared
                                                a division with six surrounding districts - Barguna,
                                                Bhola, Jhalakathi, Pirojpur, Potuakhali, and Barisal - in 1993.
                                                <br><br>
                                                The divisional headquarters of Barisal are located in
                                                the district's principal town. The Divisional Commissioner
                                                is in charge of the division. The Divisional Commissioner
                                                is the President of several departments, including the
                                                Divisional Law and Order Committee, Divisional Development
                                                Coordination Committee, Revenue Office, Regional Task Force
                                                on Smuggling Prevention, Divisional Selection Committee,
                                                and Divisional Sports Association, due to the power of
                                                the position.
                                                <br><br>
                                                The Barisal Division features a number of tourist sites
                                                located in various districts. The following are the
                                                region's main tourism attractions:
                                                <br><br>
                                                ---Potuakhali's <a href="#">Kuakata sea beach</a><br>
                                                ---Jhalakati's <a href="#">Atghar-Kuriana floating guava market</a><br>
                                                ---Barguna's <a href="#">Bibi Chini Shahi mosque</a><br>
                                                ---Bhola's <a href="#"> Monpura Island</a><br>
                                                ---Pirojpur's <a href="#">Royerkathi Palace</a><br>
                                                ---Barisal's <a href="#">Guthia Baitul Aman mosque</a><br>
                                                <br>
                                                By road, all districts in Barisal are directly connected to
                                                one another as well as to Dhaka. The areas are also accessible
                                                by air via Barisal Airport.
                                            </p>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">Top 15 Tourist Spots in Barisal Division</h2>

                                    </div>
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">Visit the most
                                            popular tourist destinations in Barisal Division.
                                            Click on a tourist attraction below for more information.</h4>
                                    </div>
                                ...
                                <div class="row" style="margin-bottom:15px;">
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <a href="barishal_barishal_guthia_baitul_aman_jame_masjid_popular_place.php"> <img style="height:100px;width:100px;" src="images/barishal2.png" class="card-img-top" alt="..."></a>
                                                </div>
                                                ...
                                                <a href="#">
                                                    <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barisal </p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <a href="barishal_barishal_lakutia_zamindar_bari_popular_place.php"> <img style="height:100px;width:100px;" src="images/barishal4.jpg" class="card-img-top" alt="...">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <a href="barishal_barishal_durga_sagar_popular_place.php"> <img style="height:100px;width:100px;" src="images/barishal3.jpg" class="card-img-top" alt="...">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <a href="barishal_barishal_barisal_divisional_museum_popular_place.php"> <img style="height:100px;width:100px;" src="images/barguna1.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <a href="barishal_pirojpur_bhandaria_shishu_park_popular_place.php"> <img style="height:100px;width:100px;" src="images/pirojpur1.jpg" class="card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                ...
                                                <a href="#">
                                                    <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Pirojpur </p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/patuakhali2.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Kuakata Sea Beach,</h2>
                                                </a>
                                                <a href="#">
                                                    <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Patuakhali </p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/barguna1.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Bibichini Shahi Mosque,</h2>
                                                </a>
                                                <a href="#">
                                                    <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna </p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/jhalokati1.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Kirtipasha Zamindar Bari,</h2>
                                                </a>
                                                <a href="#">
                                                    <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Jhalokati </p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/bhola1.jpeg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Bir Sreshtho Mostafa Kamal Memorial Museum,</h2>
                                                </a>
                                                <a href="#">
                                                    <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Bhola </p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/patuakhali1.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;">Look for Tourist Places by City</h2>
                                </div>
                                <div class="box_sundar">
                                    <h4 style="margin-top:20px;margin-bottom: 25px;">There are
                                        6 districts in Barisal Division with attractions .
                                        Browse through the districts in the following section
                                        to explore Barisal Division attractions.

                                    </h4>
                                    <ul class="row province-list">

                                        <li class="col-sm-4 col-xs-6">
                                            <a href="barishal_barguna_popular_place.php">Barguna City</a>
                                        </li>
                                        <li class="col-sm-4 col-xs-6">
                                            <a href="barishal_patuakhali_popular_place.php">Patuakhali City</a>
                                        </li>
                                        <li class="col-sm-4 col-xs-6">
                                            <a href="barishal_bhola_popular_place.php">Bhola City</a>
                                        </li>
                                        <li class="col-sm-4 col-xs-6">
                                            <a href="barishal_pirojpur_popular_place.php">Pirojpur City</a>
                                        </li>
                                        <li class="col-sm-4 col-xs-6">
                                            <a href="barishal_barishal_popular_place.php">Barisal City</a>
                                        </li>
                                        <li class="col-sm-4 col-xs-6">
                                            <a href="barishal_jhalokati_popular_place.php">Jhalokati City</a>
                                        </li>
                ...
                <div class="col-lg-4">
                    <div class="sidebar">
                        <div class="row">
                            ...
                            <div class="col-lg-12" id=moreplace>
                                <div class="sidebar-heading">
                                    <h2 style="margin-top:30px;">Find all places Division of Barisal</h2>
                                    <p>We have classified the tourism in Barisal Division into the following categories. Please select one to view all Barisal Division attractions of that type.</p><br>
                                </div>
                                <ul class="cat-filter">
                                    <li><a href="barishal_musume_popular_place.php">Museums</a> <span>(4)</span></li>
                                    <li><a href="barishal_parks_popular_place.php">Parks</a> <span>(4)</span></li>
                                    <li><a href="barishal_landmarks_popular_place.php">Landmarks</a> <span>(44)</span></li>
                                    <li><a href="barishal_natureattraction_popular_place.php">Nature Attractions</a> <span>(25)</span></li>
                                </ul>
                            </div>
