...
<head>
    <title>Shishu Park Chittagong Most Popular Place in Bangladesh</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    M A Aziz Stadium<br>Chittagong
                                                </strong>
                                            ...
                                            <hr>
                                            <b style="font-size:15px;">Type:</b> <a style="font-size:15px;" href="chitta_chitta_parks_popular_place.php">Parks,</a> <a style="font-size:15px;" href="chitta_chitta_parks_popular_place.php">Landmark</a>

                                            <hr>
                                            <div class="row" style="font-size:15px;">
                                                <div class="col-xs-6">
                                                    <i class="fa fa-facebook-square" title="Facebook"></i> <a href="https://www.facebook.com/pages/Chittagong-Shishu-Park/200606083402359" target="_blank" title="Facebook page of Bibichini Shahi Mosque" rel="noopener nofollow external">Facebook Page</a>
                                                </div>
                                                <!-- <div class="col-xs-6">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Shishu Park Chittagong</b>
                                                is a recreational area for Chittagong's city dwellers. It is
                                                located in Enayed Bazar,
                                                directly across from M.A Aziz Stadium in the heart of Chittagong.
                                                <br><br>
                                                The park is a popular destination for Chittagong residents.
                                                People from the city come here to spend their free time, especially
                                                in the afternoons with their children. Because it is located in
                                                the heart of the city, residents of Chittagong may easily visit
                                                this park. Despite the fact that the park only has a few rides
                                                and standard games with restricted riding selections, it is often
                                                crowded in the afternoon. Massive
                                                crowds are witnessed, especially on weekends and government holidays.
                                                <br><br>
                                                In the park, there is a toy railway, a merry go round, boat rides,
                                                a little roller coaster, a ferry wheel, and a small helicopter for
                                                riding. There is also a little garden on the property.
                                                <br><br>
                                                There are numerous concrete benches where you can sit and relax.
                                                There are also numerous food kiosks throughout the park. However,
                                                taking food from outside is preferable because the prices of foods
                                                in those food stalls are more than those outside.
                                                The park is best suited for youngsters under the age of fifteen.
                                                <br><br>
                                                ...
                                                in other categories. Shishu
                                                Park Chittagong's exact position may be found on the map above.
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;">Shishu Park Chittagong chitta city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">4 Kilometers
                                                    </h2>
                                                </a>
