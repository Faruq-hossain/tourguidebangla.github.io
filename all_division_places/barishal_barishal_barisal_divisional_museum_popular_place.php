...
<head>
    <title>Barisal Divisional Museum Most Popular Place in Bangladesh</title>
        ...
        <div class="page-content" style="margin-top:-20px;margin-bottom:-10px;height: auto !important; min-height: 0px !important;">
            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        <a href="barishal_barishal_museums_popular_place.php">Museum</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Fazlul Haque Avenue<br> Barisal - 8200
                                            ...
                                            <div class="row" style="font-size:15px;">
                                                ...
                                                <div class="col-xs-6">
                                                    <i class="fa fa-facebook-square" title="Facebook"></i> <a href="https://www.facebook.com/barisalmuseum" target="_blank" title="Facebook page of Bibichini Shahi Mosque" rel="noopener nofollow external">Facebook Page</a>
                                                </div>
                                                <!--    <div class="col-xs-6">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Barisal Divisional Museum</b>
                                                has been established in the district's former
                                                Collectorate building. The structure itself is a historical
                                                monument from the British era. In 2003, the Bangladeshi
                                                government designated the structure as a protected
                                                archaeological site. The
                                                process on converting the building into a museum began in 2005.
                                                <br><br>
                                                The Museum has nine galleries. Many archaeological and
                                                historical landmarks dating back about 1.5 thousand years are
                                                depicted in the galleries. Besides These galleries house around
                                                200 archaeological remains. Various archaeological patterns,
                                                old furniture, stone figures, terracotta plaques,
                                                designed bricks, inscriptions, coins, and utensils are on display.
                                                <br><br>
                                                Aside from these, the museum highlights the geographical,
                                                environmental, and administrative
                                                history of the entire country, particularly Barisal.
                                                <br><br>
                                                The galleries also illustrate the history of the Barisal
                                                Collectorate Building, a brief description of its architectural
                                                elements, and numerous types of construction materials.
                                                <br><br>
                                                In addition to this museum, there are two others in Barisal.
                                                This district also has eighteen attractions classified in other
                                                categories. The exact position
                                                of Barisal Divisional Museum may be found on the map above.
                                            </h4>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">More Museum Tourist Spot Barishal City in Barisal Division</h2>
                                        <div class="more-info-item">
                                            <span class="caption">
                                                <i class="icon icon-time"></i>
                                                Opening Hours
                                            </span>
                                            <b>Weekdays (Summer)</b>: 10:00 am - 6:00 pm
                                            <br><b>Weekdays (Winter)</b>: 9:00 am - 5:00 pm
                                        </div>
                                        ...
                                        <div class="more-info-item">
                                            ...
                                            Adult Entry: ৳ 10.00
                                            <br>Kids Entry(under 5 years): ৳ 5.00
                                            <br>Foreigners (SAARC countries): ৳&nbsp;25.00
                                            <br>Foreigners (Non-SAARC countries): ৳&nbsp;100.00
                                        </div>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Barisal Divisional Museum Barishal city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <h4>Following is a list of other landmarks found within
                                            few kilometers of Barisal Divisional Museum.
                                            You may also <a href="barishal_barishal_museums_popular_place.php">view all Museum in Barishal, Barisal Division.</a></h4>
                                    </div>
                                    <br>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title"> 20.1 Kilometers
                                                    </h2>
                                                </a>
