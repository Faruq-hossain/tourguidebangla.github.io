                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            ...
                                            <hr>
                                            <b style="font-size:15px;">Type:</b> <a style="font-size:15px;" href="barishal_pirojpur_landmarks_popular_place.php">Landmark</a>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Majherchar</b> Mathbaria, Pirojpur is the location.
                                                Apart from this natural attraction, Pirojpur has four other
                                                natural attractions. This district also has six attractions
                                                listed in other categories.

                                                Majherchar's exact location can be found on the map above.
                                            </h4>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">More Nature Attractions Tourist Spot Pirojpur City in Barisal Division</h2>

                                    </div>
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">Outside of Barguna, you can find the following
                                            Nature Attractions Pirojpur. They are listed in descending order of distance
                                            from pirojpur. </h4>
                                    </div>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;">Majherchar Pirojpur city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <p>Following is a list of other landmarks found within few kilometers
                                            of Majherchar.
                                            You may also <a href="#">view all landmarks in Pirojpur, Barisal Division.</a></p>
                                    </div>
                                    <br>
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_barguna_haringhat_forest_park_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Haringhata Forest Eco Park, <a href="#">Barguna</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 21.3 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_barguna_laldia_forest_popular_place.php"> <img style="height:100px;width:100px;" src="images/Laldia Forest1.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="barishal_barguna_laldia_forest_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Laldia Forest, <a href="#">Barguna</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 21.3 Kilometers
                                                    </h2>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_barguna_nathpotty_lake_popular_place.php"> <img style="height:100px;width:100px;" src="images/Nathpotty Lake2.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="barishal_barguna_nathpotty_lake_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Nathpotty Lake, <a href="#">Jhalokati</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 34.4 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 37.2 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <!-- <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Rayerkati Zamindar Bari.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Rayerkati Zamindar Bari, <a href="#">Pirojpur</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 11 Kilometers
                                                    </h2>
                                                </a>
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_pirojpur_momin_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Momin Mosque, <a href="#">Pirojpur</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 11.6 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="#" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Surichora Jami Mosque, <a href="#">Jhalokati</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 26.7 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#> <img style=" height:100px;width:100px;" src="images/Saturia Zamindar Bari.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Saturia Zamindar BariSaturia Zamindar Bari, <a href="#">Jhalokati</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 20.9 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_pirojpur_mothbaria_popular_place.php"> <img style="height:100px;width:100px;" src="images/Momin Mosque.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="barishal_pirojpur_mothbaria_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Mothbaria Shapleza Kuthibari, <a href="#">Pirojpur</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 22.2 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <!-- <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Parer Haat Zamindar Bari1.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Parer Haat Zamindar Bari, <a href="#">Pirojpur</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 11.3 Kilometers
                                                    </h2>
                                                </a>
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_barguna_bibicini_shahi_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Bibichini Shahi Mosque,<a href="#">Barguna</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 24.7 Kilometers
                                                    </h2>
                                                </a>
                                        ...
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="barishal_barguna_clay_fort_chaora_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Clay Fort at Chaora Patakata (Mughal period), <a href="#">Barguna</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 32.8 Kilometers
                                                    </h2>
                                                </a>
