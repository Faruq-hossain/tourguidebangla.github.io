                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            ...
                                            <div class="row" style="font-size:15px;">
                                                <div class="col-xs-6">
                                                    <i class="fa fa-facebook-square" title="Facebook"></i> <a href="https://www.facebook.com/Bibichini-Shahi-Masjid-Barguna-বিবিচিনি-শাহী-মসজিদ-বরগুনা-320913104925190/" target="_blank" title="Facebook page of Bibichini Shahi Mosque" rel="noopener nofollow external">Facebook Page</a>
                                                </div>
                                                <div class="col-xs-6">
                                                    <i class="icon icon-globe" title="Wikipedia"></i> <a href="https://bn.wikipedia.org/wiki/বিবিচিনি_মসজিদ" target="_blank" title="Wikipedia reference of Bibichini Shahi Mosque" rel="noopener nofollow external">Wikipedia</a>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                Guthia Baitul Aman Jame Masjidhas been constructed in the
                                                Guthia union of the Barisal district. The mosque is 14 acres
                                                in size. It is not simply a place of devotion, but also a
                                                tourist attraction. Guthia Mosque has no ancient or customary
                                                history. It was constructed in 2003. The mosque was erected by
                                                Sharfuddin Ahmed Senut. The mosque's construction cost
                                                approximately 20 crore taka, which was donated entirely by
                                                Sharfuddin Ahmed. The mosque was dedicated on October 20, 2006,
                                                with the Jumma Prayer. Since then, the mosque has had
                                                numerous visitors from all around the country on a daily basis.
                                                <br><br>
                                                A pond is located near the mosque's entrance gate. A variety of
                                                flowers and plants surround the pond. At the mosque's entrance,
                                                two artificial fountains have been built. The brilliant lights
                                                added to the fountains made them much more stunning at night.
                                                Three sides of the mosque have artificial waterways excavated.
                                                The mosque is designed in the style of Middle Eastern
                                                architecture. Sarfuddin Ahmed Sanut traveled to Sharjah, Dubai,
                                                Turkey, Madina, India, and Pakistan with some of his architect
                                                friends to exhibit them the architecture of exquisite mosques in
                                                those countries. The architects then created the Guthia mosque
                                                after studying numerous architectural mosques in those countries.
                                                <br><br>
                                                The pond in front of the mosque is excavated in such a way that
                                                the whole image of the mosque is reflected in the water. The
                                                verses of the Holy Quran is written by calligraphy circulating
                                                around the central dome of the mosque. Throughout the mosque,
                                                Quranic verses are written by the calligraphy. These lovely
                                                calligraphies and designs are made with colored glass, precious
                                                marble stones, granite and ceramics. Sophisticated sound systems
                                                have been installed in the mosque. About one thousand four
                                                hundred devotees can pray together
                                                inside the mosque and five thousand can do in the outer part.
                                                <br><br>

                                                Besides this landmark, there are eleven more landmarks listed

                                                in Barisal. There's also nine attractions listed in this district
                                                in other categories. You will find the exact location
                                                of Guthia Baitul Aman Jame Masjid Complex on the map above.
                                            </h4>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Guthia Baitul Aman Jame Masjid Barishal city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <p>Following is a list of other landmarks found within few kilometers of Bibichini Shahi Mosque. You may also view all landmarks in Barguna, Barisal Division.</p>
                                    </div>
                                    <br>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Birshreshtho Captain Mohiuddin Jahangir Memorial Museum1.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Birshreshtho Captain Mohiuddin Jahangir Memorial Museum, <a href="#"> Barisal</a> </h2>
                                                </a>
                                                <a href="#">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Kalamia Jamidar Bari.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Kalamia Jamidar Bari, <a href="#">Barisal</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barishal to 21.1 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Lakutia Zamindar Bari, <a href="#">Barisal</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barishal to 22.5 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Braj Mohan College, <a href="#">Barisal</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barishal to 28.5 Kilometers
                                                    </h2>
                                                </a>
