                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <p style="margin-top:15px;">
                                                <b>Sutabaria Dayamayee Mandir</b>is located at Galachipa ,
                                                Patuakhali. Besides this landmark, there are eight more
                                                landmarks listed in Patuakhali. There's also six attractions
                                                listed in this district in other categories.

                                                You will find the exact location of Sutabaria Dayamayee Mandir on the map above.
                                            </p>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Sutabaria Dayamayee Mandir Patuakhali city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 23.3 Kilometers
                                                    </h2>
                                                </a>
