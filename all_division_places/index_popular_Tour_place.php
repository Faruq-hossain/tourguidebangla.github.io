                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="down-content" id="#">
                                            <h2 style="margin-left: -30px;">Popular Tourist Places in Bangladesh</h2>
                                        </div>
                                    ...
                                    <div class="box_sundar">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="card_popular">
                                                        <img src="images/Museums1.jfif" alt="">
                                                        <div class="card-text-popular">
                                                            <a href="museums_popular_Tour_place.php">
                                                                <h3>MUSEUMS</h3>
                                                            </a>
                                                            <h5>Nice place</h5>
                                                        </div>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="card_popular">
                                                        ...
                                                        <div class="card-text-popular">
                                                            <a href="parks_popular_Tour_place.php">
                                                                <h3>PARKS</h3>
                                                            </a>
                                                            <h5>Nice place</h5>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="card_popular">
                                                        ...
                                                        <div class="card-text-popular">
                                                            <a href="landmarks_popular_Tour_place.php">
                                                                <h3>LANDMARKS</h3>
                                                            </a>
                                                            <h5>Nice place</h5>
                                                        </div>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="card_popular">
                                                        ...
                                                        <div class="card-text-popular">
                                                            <a href="nature_attraction_popular_Tour_place.php">
                                        ...
                                        <div class="container_popular">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="card_popular">
                                                        <img src="images/Zoos.jpg" alt="">
                                                        <div class="card-text-popular">
                                                            <a href="zoo_popular_Tour_place.php">
                                                                <h3>ZOOS</h3>
                                                            </a>
                                                            <h5>Nice place</h5>
                                                        </div>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="card_popular">
                                                        <img src="images/articles1.jfif" alt="">
                                                        <div class="card-text-popular">
                                                            <a href="articles_popular_Tour_place.php">
                                                                <h3>ARTICLES</h3>
                                                            </a>
                                                            <h5>Nice place</h5>
                                                        </div>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;">Search By Places by Division</h2>
                                </div>
                                <div class="box_sundar" style="margin-top:20px;">
                                    ...
                                    <ul class="row province-list">
                                        ...
                                        <li class="col-sm-3 col-xs-6">
                                            <a href="chitta_division_popular_place.php">Chattogram Division</a>
                                        </li>
                                        <li class="col-sm-3 col-xs-6">
