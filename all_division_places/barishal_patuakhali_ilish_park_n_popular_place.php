        ...
        <div class="page-content" style="margin-top:-20px;margin-bottom:-10px;height: auto !important; min-height: 0px !important;">
            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        <a href="barishal_patuakhali_parks_popular_place.php">Parks</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        Ilish Park
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            ...
                                            <hr>
                                            <b style="font-size:15px;">Type:</b> <a style="font-size:15px;" href="barishal_patuakhali_parks_popular_place.php">Parks,</a> <a style="font-size:15px;" href="barishal_patuakhali_natureattraction_popular_place.php">Landmark</a>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <p style="margin-top:15px;">
                                                <b>Ilish Park</b>Kuakata, Patuakhali is the location.
                                                Patuakhali's only amusement park is listed below. In a
                                                ddition, fourteen attractions in other categories are
                                                mentioned in this district.
                                                The exact position of Ilish Park may be found on the map above.
                                            </p>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;">Ilish Park Patuakhali city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
