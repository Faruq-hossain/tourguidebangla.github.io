...
<head>
    <title>Bikrampur Museum (Agrashar Bikrampur Foundation)
        ...
        <div class="page-content" style="margin-top:-20px;margin-bottom:-10px;height: auto !important; min-height: 0px !important;">
            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        <a href="dhaka_munshiganj_popular_place.php">Munshiganj</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        <a href="dhaka_munshiganj_museums_popular_place.php">Museum</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        Bikrampur Museum (Agrashar Bikrampur Foundation)
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            ...
                                            <hr>
                                            <b style="font-size:15px;">Type:</b> <a style="font-size:15px;" href="dhaka_munshiganj_landmarks_popular_place.php">Landmarks</a> <a style="font-size:15px;" href="dhaka_munshiganj_museums_popular_place.php">Museum</a>
                                            ...
                                            <div class="row" style="font-size:15px;">
                                                ...
                                                <div class="col-xs-6">
                                                    <i class="icon icon-globe" title="Wikipedia"></i> <a href="https://bn.wikipedia.org/wiki/বীরশ্রেষ্ঠ_মুন্সী_আবদুর_রউফ_স্মৃতি_জাদুঘর_ও_পাঠাগার" target="_blank" title="Wikipedia reference of Bibichini Shahi Mosque" rel="noopener nofollow external"> Wikipedia
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Bikrampur Museum (Agrashar Bikrampur Foundation)
                                                </b>
                                                is situated in Munshiganj's Louhajong. Munshiganj's only museum
                                                is listed below. This district also has nine attractions listed
                                                in other categories. Bikrampur Museum's specific
                                                location will be revealed (Agrashar Bikrampur Foundation)
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Bikrampur Museum (Agrashar Bikrampur Foundation)
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <h4>Following is a list of other museum found within
                                            few kilometers of Bikrampur Museum (Agrashar Bikrampur Foundation)
                                            .
                                            You may also <a href="dhaka_munshiganj_museums_popular_place.php"> view all museums in munshiganj, Dhaka Division.</a></h4>
                                    </div>
                                    <br>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title"> 28.5 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title"> 30 Kilometers
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title"> 30.4 Kilometers
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title"> 30.5 Kilometers
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title"> 30.7 Kilometers
                                                </a>
