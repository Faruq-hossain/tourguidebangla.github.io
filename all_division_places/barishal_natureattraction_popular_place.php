                                ...
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="down-content" id="#">
                                            <h2 style="margin-left: -30px;">Discover Nature Attractions in Barisal Division.</h2>
                                        </div>
                                        <div class="box_sundar">
                                            <!-- <h4>Sundarban</h4> -->
                                            <p style="margin-top:15px;">
                                                <b>Barisal Division has 25 natural attractions. places</b> This accounts for roughly one-third of all
                                                tourist attractions in the region. <a href="#">Patuakhali</a>, <a href="#">Barisal</a>,
                                                <a href="#">Barguna</a>,
                                                <a href="#">Pirojpur</a>, and <a href="#">Jhalokati</a> are the top districts in Barisal Division
                                                having popular natural attractions. On this page, you can discover
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">Top 10 Tourist Nature Attractions in Barisal Division</h2>

                                    </div>
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">Visit the most
                                            popular tourist <b>Nature Attractions in Barisal Division.</b>
                                ...
                                <div class="row" style="margin-bottom:15px;">
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Haringhata Forest Eco Park1.jfif" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Laldia Forest1.jpg" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Fatrar Bon (Forest) & Eco Park1.jfif" class="card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Durga Sagar1.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Bibi'r Pukur.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Char Kukri-Mukri.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Floating Market & Guava Garden.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Floating Market in Kuriana.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Kuakata Sea Beach.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px;">
                                            <div class="card-body">
                                                <div class="col-sm-5">
                                                    <img style="height:100px;width:100px;" src="images/Fatrar Char.jpg" class=" card-img-top" alt="...">
                                                </div>
                                                <a href="#">
