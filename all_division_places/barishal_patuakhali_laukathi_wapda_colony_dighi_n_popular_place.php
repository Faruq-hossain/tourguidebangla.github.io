                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Laukathi<br>Patuakhali Sadar<br>Patuakhali
                                                </strong>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Laukathi Wapda Colony Dighi</b>is located in Patuakhali,
                                                Patuakhali Sadar, Laukathi. Patuakhali has five other nature
                                                attractions listed in addition to this one. This district also
                                                has nine attractions listed in other categories. The exact
                                                location
                                                of Laukathi Wapda Colony Dighi may be found on the map above.
                                            </h4>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Laukathi Wapda Colony Dighi Patuakhali city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        ...
                                        <p>Following is a list of other Nature Attractions found within few kilometers
                                            of Laukathi Wapda Colony Dighi.
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href=""> <img style="height:100px;width:100px;" src="images/City Park.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">City Park, <a href="#">Jhalokati</a> </h2>
                                                </a>
                                                <a href="#">
