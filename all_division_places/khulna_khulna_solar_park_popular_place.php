...
<head>
    <title>Solar Park Most Popular Place in Bangladesh</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                ...
                                                Sonadanga R/A, Khulna - 9000 is the address. In addition to this natural
                                                feature, Khulna has four other natural attractions. This district
                                                also has twelve attractions classified in other categories.
                                                The exact position of Solar Park may be found on the map above.
                                            </h4>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Solar Park khulna city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">1.8 Kilometers
                                                    </h2>
                                                </a>
