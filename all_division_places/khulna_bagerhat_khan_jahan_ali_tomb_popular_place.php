...
<head>
    <title>Khan Jahan Ali's Tomb Most Popular Place in Bangladesh</title>
        ...
        <div class="page-content" style="margin-top:-20px;margin-bottom:-10px;height: auto !important; min-height: 0px !important;">
            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        <a href="barishal_bagerhat_landmarks_popular_place.php">landmarks</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            ...
                                            <hr>
                                            <b style="font-size:15px;">Type:</b> <a style="font-size:15px;" href="Khulna_bagerhat_landmarks_popular_place.php">Nature Attraction</a>
                                            ...
                                            <div class="row" style="font-size:15px;">
                                                ...
                                                <div class="col-xs-6">
                                                    <i class="icon icon-globe" title="Wikipedia"></i> <a href="https://en.wikipedia.org/wiki/Khan_Jahan_Ali" target="_blank" title="Wikipedia reference of Bibichini Shahi Mosque" rel="noopener nofollow external">Wikipedia</a>
                                                    <br><br>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <h4 style="margin-top:15px;">
                                                <b>Khan Jahan Ali's Tomb</b>
                                                is located in Bagerhat. Besides this landmark, there are eight more
                                                landmarks listed in Bagerhat. There's also ten attractions listed in
                                                this district in other categories.
                                                You will find the exact location of Khan Jahan Ali's Tomb on the map above.
                                            </h4>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">More Nature Attractions Tourist Spot bagerhat City in Khulna Division</h2>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Khan Jahan Ali's Tomb Bagerhat city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="sidebar-item categories">
                                    <div class="sidebar-heading">
                                        <h2>bagerhat Google map with Nature Attractions</h2>
                                    </div>
                                    <div class="content">
                                        <div id="map"></div>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        <h2>Nearby Nature Attractions in bagerhat city</h2>
                                        <p>Other natural sites within a few kilometers
                                            of Haringhata Forest Eco Park are listed below.
                                            You can also <a href="khulna_bagerhat_landmarks_popular_place.php">look at all of the natural attractions
                                                in bagerhat, khulna Division.</a></p>
                                    </div>
                                    <br>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="khulna_bagerhat_jindapirer_mosque_popular_place.php"> <img style="height:100px;width:100px;" src="images/Jindapirer Masjid.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="khulna_bagerhat_jindapirer_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Jindapirer Masjid, <a href="khulna_bagerhat_landmarks_popular_place.php">Bagerhat</a> </h2>
                                                </a>
                                                <a href="#">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="khulna_bagerhat_hussain_shahi_mosque_popular_place.php"> <img style="height:100px;width:100px;" src="images/Hussain Shahi Masjid2.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="khulna_bagerhat_hussain_shahi_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Hussain Shahi Masjid, <a href="khulna_bagerhat_landmarks_popular_place.php">Bagerhat</a> </h2>
                                                </a>
                                                <a href="#">
                                    ...
                                    <!-- <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="khulna_bagerhat_khan_jahan_ali_tomb_popular_place.php"> <img style="height:100px;width:100px;" src="images/Khan Jahan Ali's Tomb.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="khulna_bagerhat_khan_jahan_ali_tomb_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Khan Jahan Ali's Tomb, <a href="khulna_bagerhat_landmarks_popular_place.php">Bagerhat</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">0.7 Kilometers
                                                    </h2>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="khulna_bagerhat_ronvijoypur_mosque_popular_place.php"> <img style="height:100px;width:100px;" src="images/Ronvijoypur Mosque.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="khulna_bagerhat_ronvijoypur_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Ronvijoypur Mosque, <a href="khulna_bagerhat_landmarks_popular_place.php">Bagerhat</a> </h2>
                                                </a>
                                                <a href="#">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="khulna_bagerhat_shaat_gombuj_mosque_popular_place.php"> <img style="height:100px;width:100px;" src="images/Shaat Gombuj Mosque.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="khulna_bagerhat_shaat_gombuj_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Shaat Gombuj Mosque, <a href="khulna_bagerhat_landmarks_popular_place.php">Bagerhat</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">2.3 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="khulna_bagerhat_nine_dome_mosque_popular_place.php"> <img style="height:100px;width:100px;" src="images/Nine Dome Mosque.jfif" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="khulna_bagerhat_nine_dome_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Nine Dome Mosque, <a href="khulna_bagerhat_landmarks_popular_place.php">Bagerhat</a> </h2>
                                                </a>
                                                <a href="#">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="khulna_bagerhat_bibi_begani_mosque_popular_place.php"> <img style="height:100px;width:100px;" src="images/Bibi Begani Mosque.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="khulna_bagerhat_bibi_begani_mosque_popular_place.php">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Bibi Begani Mosque, <a href="khulna_bagerhat_landmarks_popular_place.php">Bagerhat</a> </h2>
                                                </a>
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">3.1 Kilometers
                                                    </h2>
                                                </a>
