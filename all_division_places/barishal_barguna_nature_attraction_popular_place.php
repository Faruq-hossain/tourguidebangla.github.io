        ...
        <div class="page-content" style="margin-top:-20px;margin-bottom:-10px;height: auto !important; min-height: 0px !important;">
            ...
            <div class="bc-links">
                <ol class="breadcrumb">
                    ...
                    <li class="active" style="font-size:15px;">
                        <a href="barishal_barguna_popular_place.php">Barguna</a>
                    </li>
                    <li class="active" style="font-size:15px;">
                        Barguna Nature Attractions Place
                    </li>
                </ol>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-thumb">
                                        ...
                                        <div class="down-content" id="#">
                                            <h2 style="margin-left: -30px;">Discover Nature Attractions Tourist places Barguna city in Barisal Division.</h2>
                                        </div>
                                        <div class="box_sundar">
                                            <!-- <h4>Sundarban</h4> -->
                                            <p style="margin-top:15px;">
                                                In Barguna, there are 5 Nature Attractions. This
                                                represents more than half of the tourist attractions listed in
                                                this district. On this page,
                                                you may select from a list of all types of Barguna attractions.
                                            </p>
                                    ...
                                    <div class="down-content" id="#">
                                        <h2 style="margin-left: -30px;">Top Nature Attractions Tourist Spot Barguna City in Barisal Division</h2>

                                    </div>
                                    <div class="box_sundar">
                                        <h4 style="margin-top:20px;margin-bottom: 25px;">The following is a list of all the <b>Nature Attractions</b> in <b>Barguna</b>.
                                            The <b>natural attractions</b> are ranked by popularity, which is
                                            determined by the number of visits, user ratings, and a few other
                                            characteristics. You can use the
                                            'Arrange By' option to sort them alphabetically by their names. </h4>
                                    </div>
                                    ...
                                    <div class="row" style="margin-bottom:15px;">
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="#"><img style="height:100px;width:100px;" src="images/Haringhata Forest Eco Park1.jfif" class=" card-img-top" alt="..."></a>
                                                    </div>
                                                    <a href="">
                                                        <h2 style="font-weight:bold;font-size:15px;" class="card-title">Haringhata Forest Eco Park</h2>
                                                    </a>
                                                    <p>Patharghata , Barguna
                                                    </p>
                                                    <a href="#">
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="#"><img style="height:100px;width:100px;" src="images/Fatrar Bon (Forest) & Eco Park1.jfif" class=" card-img-top" alt="..."></a>
                                                    </div>
                                                    <a href="">
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="#"><img style="height:100px;width:100px;" src="images/Sonakata Sea Beach.jpg" class=" card-img-top" alt="..."></a>
                                                    </div>
                                                    <a href="">
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="#"><img style="height:100px;width:100px;" src="images/Nathpotty Lake2.jfif" class=" card-img-top" alt="..."></a>
                                                    </div>
                                                    <a href="">
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    <div class="col-sm-5">
                                                        <a href="barishal_barguna_bibicini_shahi_mosque_popular_place.php"> <img style="height:100px;width:100px;" src="images/Bibichini Shahi Mosque1.jpg" class=" card-img-top" alt="...">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="down-content" id="#">
                                            <h2 style="margin-left: -30px;">More Landmarks Tourist Spot Barguna City in Barisal Division</h2>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 16.5 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 20.8 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 26.2 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 30.5 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 31.6 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 36.4 Kilometers </p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 37 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 38.5 Kilometers</p>
                                                    </a>
                                        ...
                                        <div class="col-sm-6" style="margin-bottom:15px;">
                                            <div class="card" style=" border-radius: 5px;">
                                                <div class="card-body">
                                                    ...
                                                    <a href="#">
                                                        <p style="font-weight:bold;margin-bottom:1px;" class="card-text">Barguna to 46.1 Kilometers</p>
                                                    </a>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;">Barguna city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="sidebar-item categories">
                                    <div class="sidebar-heading">
                                        <h2>Barguna Google map with Landmarks</h2>
                                    </div>
                                    <div class="content">
                                        <div id="map"></div>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="sidebar-item recent-posts">
                                    <div class="sidebar-heading">
                                        <h2>Top Barguna city Landmarks</h2>
                                    </div>
                                    <div class="card_side align-items-center" style="max-width: 540px;">
                                        <a href="barishal_barguna_bibicini_shahi_mosque_popular_place.php"> <img src="images/Bibichini Shahi Mosque1.jpg" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card_side-body">
                                            <a href="barishal_barguna_bibicini_shahi_mosque_popular_place.php" style="font-size: 15px;font-weight:bold;" class="card-title">Bibichini Shahi Mosque</a>
                                            <!-- <p class="card_side-text">Sundarbans Is The World's Largest Mangrove Forest... </p> -->
                                            <!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="card_side align-items-center" style="max-width: 540px;">
                                        <a href="barishal_barguna_clay_fort_chaora_popular_place.php"> <img src="images/Clay Fort at Chaora Patakata (Mughal period).jfif" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card_side-body">
                                            <a href="barishal_barguna_clay_fort_chaora_popular_place.php" style="font-size: 15px;font-weight:bold;" class="card-title">Clay Fort at Chaora Patakata</a>
                                            <!-- <p class="card_side-text">Sundarbans Is The World's Largest Mangrove Forest... </p> -->
                                            <!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="card_side align-items-center" style="max-width: 540px;">
                                        <a href="barishal_barguna_tomb_kazi_kalu_popular_place.php"> <img src="images/Tomb of Kazi Kalu at Tepura.jfif" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card_side-body">
                                            <a href="barishal_barguna_tomb_kazi_kalu_popular_place.php" style="font-size: 15px;font-weight:bold;" class="card-title">Tomb of Kazi Kalu at Tepura</a>
                                            <!-- <p class="card_side-text">Sundarbans Is The World's Largest Mangrove Forest... </p> -->
                                            <!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12" id=moreplace>
                                ...
                                <ul class="cat-filter">
                                    <li><a href="barishal_barguna_landmarks_place.php">Landmarks</a> <span>(3)</span></li>
