                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="blog-thumb">
                                        <div class="left" style="background-color:#fffccc;text-align:center;">
                                            <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                                                <strong style="font-size:15px;">
                                                    Burirchar<br>Mathbaria<br> Pirojpur
                                                </strong>
                                        ...
                                        <div class="box_sundar">
                                            ...
                                            <p style="margin-top:15px;">
                                                <b>Momin Mosque </b> is
                                                Burirchar, Mathbaria, and Pirojpur are the locations.
                                                Pirojpur has four other landmarks in addition to this one.
                                                This district also has six attractions listed in other categories.

                                                The exact position of Momin Mosque may be found on the map above.
                                            </p>
                                ...
                                <div class="down-content" id="place_division">
                                    <h2 style="margin-left: -30px;"> Momin Mosque Pirojpur city Driving Directions</h2>
                                </div>
                                <div class="box_sundar">
                                ...
                                <div class="sidebar-item recent-posts">
                                    ...
                                    <!-- <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="#"> <img style="height:100px;width:100px;" src="images/Momin Mosque.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="#">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 22.6 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 28.3 Kilometers
                                                    </h2>
                                                </a>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        <div class="card" style=" border-radius: 5px; background-color:#fffccc;">
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <a href="barishal_barguna_clay_fort_chaora_popular_place.php"> <img style="height:100px;width:100px;" src="images/Saturia Zamindar Bari.jpg" class=" card-img-top" alt="...">
                                                    </a>
                                                </div>
                                                <a href="barishal_barguna_clay_fort_chaora_popular_place.php">
                                                ...
                                                <a href="#">
                                                    <h2 style="font-weight:bold;font-size:15px;" class="card-title">Barguna to 29.1 Kilometers
                                                    </h2>
                                                </a>
